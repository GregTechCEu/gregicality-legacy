...
public class GAFirstDegreeMaterials {
    ...
    public static void register() {
        ...
        BismuthTellurite = new Material.Builder(3510, "bismuth_tellurite")
                .dust()
