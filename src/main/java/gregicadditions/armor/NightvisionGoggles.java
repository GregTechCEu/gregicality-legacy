...
public class NightvisionGoggles extends ArmorLogicSuite{
    ...
    public NightvisionGoggles() {
        super(GAConfig.equipment.nightvisionGoggles.energyPerUse, GAConfig.equipment.nightvisionGoggles.capacity, GAConfig.equipment.nightvisionGoggles.voltageTier, EntityEquipmentSlot.HEAD);
    }
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        if (SLOT == EntityEquipmentSlot.HEAD) {
            ...
            if (nightvision && !world.isRemote && item.getCharge() >= (energyPerUse / 100)) {
                ...
                ret = true;
                item.discharge((energyPerUse / 100), GAConfig.equipment.nightvisionGoggles.voltageTier, true, false, false);
            }
