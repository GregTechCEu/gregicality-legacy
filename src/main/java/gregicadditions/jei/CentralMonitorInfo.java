...
public class CentralMonitorInfo extends MultiblockInfoPage {
    ...
    public String[] getDescription() {
        return new String[]{
                I18n.format("gtadditions.multiblock.central_monitor.tooltip.2", MetaTileEntityCentralMonitor.MAX_WIDTH, MetaTileEntityCentralMonitor.MAX_HEIGHT),
                I18n.format("gtadditions.multiblock.central_monitor.tooltip.3")
        };
    }
}
