...
public class LargeMinerInfo extends MultiblockInfoPage {
	...
	public List<MultiblockShapeInfo> getMatchingShapes() {
		MultiblockShapeInfo shapeInfo = MultiblockShapeInfo.builder()
				...
				.where('C', GAMetaBlocks.METAL_CASING.get(largeMiner.getMaterial()).getDefaultState())
				.where('P', GAMetaBlocks.METAL_CASING.get(largeMiner.getMaterial()).getDefaultState())
	...
	public String[] getDescription() {
		return new String[]{I18n.format("gregtech.multiblock.large_miner.description")};
	}
}
