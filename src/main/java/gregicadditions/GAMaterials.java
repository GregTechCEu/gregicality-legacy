...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleDustMaterial Succinimide = new SimpleDustMaterial("succinimide", 0xbf95f5, (short) 65, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 5), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial Bromosuccinimide = new SimpleDustMaterial("bromo_succinimide", 0xbf95f5, (short) 66, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 4), new MaterialStack(Bromine, 1), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2)));
    ...
    public static final SimpleFluidMaterial MesitylOxide = new SimpleFluidMaterial("mesityl_oxide", Acetone.materialRGB-10);
    ...
    public static final SimpleFluidMaterial Diethylether = new SimpleFluidMaterial("diethylether", AcidifiedPolyphenolMix.rgb-20);
    public static final SimpleFluidMaterial TannicAcid = new SimpleFluidMaterial("tannic_acid", (Diethylether.rgb+AcidifiedPolyphenolMix.rgb)/4);
    ...
    public static final SimpleFluidMaterial GermaniumChloride = new SimpleFluidMaterial("germanium_chloride", (Germanium.materialRGB+Chlorine.materialRGB)/2);
