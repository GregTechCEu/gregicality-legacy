...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleFluidMaterial Pyridine = new SimpleFluidMaterial("pyridine", 0x755f30, of(new MaterialStack(Carbon, 5), new MaterialStack(Hydrogen, 5), new MaterialStack(Nitrogen, 1)));
    public static final SimpleFluidMaterial Phenylpentanoicacid = new SimpleFluidMaterial("phenylpentanoicacid", 0x755f30, of(new MaterialStack(Carbon, 11), new MaterialStack(Hydrogen, 14), new MaterialStack(Oxygen, 2)));
    public static final SimpleFluidMaterial Dimethylsulfide = new SimpleFluidMaterial("dimethylsulfide", 0x755f30, of(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 6), new MaterialStack(Sulfur, 1)));
    public static final SimpleFluidMaterial BenzoylChloride = new SimpleFluidMaterial("benzoyl_chloride", 0x755f30, of(new MaterialStack(Carbon, 7), new MaterialStack(Hydrogen, 5), new MaterialStack(Chlorine, 1), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial Silvertetrafluoroborate = new SimpleFluidMaterial("silvertetrafluoroborate", 0x755f30, of(new MaterialStack(Silver, 1), new MaterialStack(Boron, 1), new MaterialStack(Fluorine, 4)));
    public static final SimpleFluidMaterial PCBA = new SimpleFluidMaterial("pcba", 0x755f30); // TODO
    public static final SimpleFluidMaterial PCBS = new SimpleFluidMaterial("pcbs", 0x755f30); // TODO
    public static final SimpleFluidMaterial Ferrocene = new SimpleFluidMaterial("ferrocene", 0x755f30, of(new MaterialStack(Iron, 1), new MaterialStack(Carbon, 10), new MaterialStack(Hydrogen, 10)));
    ...
    public static final SimpleFluidMaterial Hydroquinone = new SimpleFluidMaterial("hydroquinone", 0x755f30, "C6H4(OH)2");
    public static final SimpleFluidMaterial SodiumAcetate = new SimpleFluidMaterial("sodium_acetate", 0x755f30, of(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 3), new MaterialStack(Sodium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleFluidMaterial PotassiumHydroxide = new SimpleFluidMaterial("potassium_hydroxide", 0x755f30, of(new MaterialStack(Potassium, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Hydrogen, 1)));
    ...
    public static final SimpleFluidMaterial AmineMixture = new SimpleFluidMaterial("amine_mixture", 0x755f30, "(NH3)CH4");
    ...
    public static final SimpleFluidMaterial ButanolGas = new SimpleFluidMaterial("butanol_gas",Butanol.rgb, "C4H9OH");
    ...
    public static final SimpleDustMaterial SilicaAluminaGel = new SimpleDustMaterial("silica_alumina_gel", 0x558d9e, (short) 29, MaterialIconSet.DULL, ChatFormatting.OBFUSCATED.toString() + ChatFormatting.ITALIC.toString() + "a" + ChatFormatting.RESET.toString() + "(u2)d(c2)s(t2)bg" + ChatFormatting.OBFUSCATED.toString() + "a", true); // TODO Swap to [Al2O3?]
    public static final SimpleDustMaterial ZeoliteSievingPellets = new SimpleDustMaterial("zeolite_sieving_pellets", 0xa17bd1, (short) 30, MaterialIconSet.DULL, "Al2O3?");
    public static final SimpleDustMaterial WetZeoliteSievingPellets = new SimpleDustMaterial("wet_zeolite_sieving_pellets", 0x392f45, (short) 31, MaterialIconSet.DULL, "Al2O3??");
    ...
    public static final SimpleDustMaterial PreZylon = new SimpleDustMaterial("pre_zylon", 0xbf95f5, (short) 82, MaterialIconSet.DULL, "C20H22N2O2");
    ...
    public static final SimpleDustMaterial LanthanumFullereneMix = new SimpleDustMaterial("lanthanum_fullerene_mix", 0xdfcafa, (short) 212, MaterialIconSet.SHINY, of(new MaterialStack(Lanthanum, 2), new MaterialStack(Carbon, 120), new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial LanthanumEmbeddedFullerene = new SimpleDustMaterial("lanthanum_embedded_fullerene", 0x99cc00, (short) 213, MaterialIconSet.SHINY, of(new MaterialStack(Lanthanum, 2), new MaterialStack(Carbon, 120)));
    public static final SimpleDustMaterial IronIodide = new SimpleDustMaterial("iron_iodide", 0x7a7a66, (short) 214, MaterialIconSet.DULL, of(new MaterialStack(Iron, 1), new MaterialStack(Iodine, 2)));
    public static final SimpleDustMaterial PotassiumIodide = new SimpleDustMaterial("potassium_iodide", 0x7a7a66, (short) 215, MaterialIconSet.DULL, of(new MaterialStack(Potassium, 1), new MaterialStack(Iodine, 1)));
    public static final SimpleDustMaterial ThalliumIodide = new SimpleDustMaterial("thallium_iodide", 0x7a7a66, (short) 216, MaterialIconSet.DULL, of(new MaterialStack(Thallium, 1), new MaterialStack(Iodine, 1)));
    public static final SimpleDustMaterial ScandiumIodide = new SimpleDustMaterial("scandium_iodide", 0x7a7a66, (short) 217, MaterialIconSet.DULL, of(new MaterialStack(Scandium, 1), new MaterialStack(Iodine, 3)));
    public static final SimpleDustMaterial RubidiumIodide = new SimpleDustMaterial("rubidium_iodide", 0x7a7a66, (short) 218, MaterialIconSet.DULL, of(new MaterialStack(Rubidium, 1), new MaterialStack(Iodine, 1)));
    public static final SimpleDustMaterial IndiumIodide = new SimpleDustMaterial("indium_iodide", 0x7a7a66, (short) 219, MaterialIconSet.DULL, of(new MaterialStack(Indium, 1), new MaterialStack(Iodine, 3)));
    public static final SimpleDustMaterial GalliumIodide = new SimpleDustMaterial("gallium_iodide", 0x7a7a66, (short) 220, MaterialIconSet.DULL, of(new MaterialStack(Gallium, 1), new MaterialStack(Iodine, 3)));
    public static final SimpleDustMaterial UVAHalideMix = new SimpleDustMaterial("uva_halide_mix", 0x660066, (short) 221, MaterialIconSet.DULL, "?"); // TODO: CHANGE COLORS
    ...
    public static final SimpleDustMaterial YttriumEuropiumVanadate = new SimpleDustMaterial("yttrium_europium_vanadate", 0xfcfcfa, (short) 242, MaterialIconSet.DULL, of(new MaterialStack(Yttrium, 1), new MaterialStack(Europium, 1), new MaterialStack(Vanadium, 4), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial StrontiumEuropiumAluminate = new SimpleDustMaterial("strontium_europium_aluminate", 0xfcfcfa, (short) 243, MaterialIconSet.DULL, "SrAl2O4");
    ...
    public static final SimpleDustMaterial BETS = new SimpleDustMaterial("bets", 0x7ada00, (short) 253, MaterialIconSet.SHINY, "Bisethylenedithiotetraselenafulvalene");
    ...
    public static final SimpleDustMaterial NeodymiumDopedYttrium = new SimpleDustMaterial("neodymium_doped_yttrium",YttriumOxide.materialRGB,(short) 268,MaterialIconSet.DULL, "Nd:YAG"); // TODO
