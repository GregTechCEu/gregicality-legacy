...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleDustMaterial SilicaAluminaGel = new SimpleDustMaterial("silica_alumina_gel", 0x558d9e, (short) 29, MaterialIconSet.DULL, ChatFormatting.OBFUSCATED + "a" + ChatFormatting.RESET + "(u2)d(c2)s(t2)bg" + ChatFormatting.OBFUSCATED + "a", true); // TODO Swap to [Al2O3?]
