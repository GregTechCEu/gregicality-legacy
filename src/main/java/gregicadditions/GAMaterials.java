...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final DustMaterial ReRhodium = new DustMaterial(860, "reprecipitated_rhodium", Rhodium.materialRGB-10, MaterialIconSet.QUARTZ, 2, of(new MaterialStack(Rhodium, 1), new MaterialStack(RareEarth, 1)), DISABLE_DECOMPOSITION);
    // FREE ID 849
