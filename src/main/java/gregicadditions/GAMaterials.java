...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleDustMaterial SodiumChlorate = new SimpleDustMaterial("sodium_chlorate", Salt.materialRGB, (short) 901, MaterialIconSet.DULL);
    public static final SimpleDustMaterial LeadSulfate = new SimpleDustMaterial("lead_sulfate", Lead.materialRGB+LeadNitrate.materialRGB/2, (short) 375, MaterialIconSet.DULL);
