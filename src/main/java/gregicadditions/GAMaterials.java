...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleFluidMaterial PropargylAlcohol = new SimpleFluidMaterial("propargyl_alcohol", 0xbfb32a, of(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 4), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial PropargylChloride = new SimpleFluidMaterial("propargyl_chloride", 0x918924, of(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 3), new MaterialStack(Chlorine, 1)));
    public static final SimpleFluidMaterial Citral = new SimpleFluidMaterial("citral", 0xf2e541, of(new MaterialStack(Carbon, 10), new MaterialStack(Hydrogen, 16), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial BetaIonone = new SimpleFluidMaterial("beta_ionone", 0xdc5ce6, of(new MaterialStack(Carbon, 13), new MaterialStack(Hydrogen, 20), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial VitaminA = new SimpleFluidMaterial("vitamin_a", 0x8d5c91, of(new MaterialStack(Carbon, 20), new MaterialStack(Hydrogen, 30), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial EthyleneOxide = new SimpleFluidMaterial("ethylene_oxide", 0xa0c3de, of(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 4), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial Ethanolamine = new SimpleFluidMaterial("ethanolamine", 0x6f7d87, of(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 7), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial Biotin = new SimpleFluidMaterial("biotin", 0x68cc6a, of(new MaterialStack(Carbon, 10), new MaterialStack(Hydrogen, 16), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 3), new MaterialStack(Sulfur, 1)));
    ...
    public static final SimpleFluidMaterial EGF = new SimpleFluidMaterial("egf", 0x815799, of(new MaterialStack(Carbon, 257), new MaterialStack(Hydrogen, 381), new MaterialStack(Nitrogen, 73), new MaterialStack(Oxygen, 83), new MaterialStack(Sulfur, 7)));
    public static final SimpleFluidMaterial NitroBenzene = new SimpleFluidMaterial("nitro_benzene", 0x81c951, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 5), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleFluidMaterial Aniline = new SimpleFluidMaterial("aniline", 0x4c911d, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 5), new MaterialStack(Nitrogen, 1), new MaterialStack(Hydrogen, 2))); // TODO Check if this works
    public static final SimpleFluidMaterial ChlorosulfuricAcid = new SimpleFluidMaterial("chlorosulfuric_acid", 0x916c1d, of(new MaterialStack(Hydrogen, 1), new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 3), new MaterialStack(Chlorine, 1)));
    public static final SimpleFluidMaterial Sulfanilamide = new SimpleFluidMaterial("sulfanilamide", 0x523b0a, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 8), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2), new MaterialStack(Sulfur, 1)));
    ...
    public static final SimpleFluidMaterial PiranhaSolution = new SimpleFluidMaterial("piranha_solution", 0x4820ab, of(new MaterialStack(SulfuricAcid, 3), new MaterialStack(HydrogenPeroxide, 1)));
    ...
    public static final SimpleFluidMaterial LinoleicAcid = new SimpleFluidMaterial("linoleic_acid", 0xD5D257, of(new MaterialStack(Carbon, 18), new MaterialStack(Hydrogen, 32), new MaterialStack(Oxygen, 2)));
    public static final SimpleFluidMaterial SiliconFluoride = new SimpleFluidMaterial("silicon_fluoride", 0xB2B4B4, of(new MaterialStack(Silicon, 1), new MaterialStack(Fluorine, 4)));
    public static final SimpleFluidMaterial CarbonFluoride = new SimpleFluidMaterial("carbone_fluoride", 0xE6E6E6, "CF4");
    public static final SimpleFluidMaterial PhosphorusTrichloride = new SimpleFluidMaterial("phosphorus_trichloride", 0xE6E6E6, of(new MaterialStack(Phosphorus, 1), new MaterialStack(Chlorine, 3)));
    public static final SimpleFluidMaterial PhosphorylChloride = new SimpleFluidMaterial("phosphoryl_chloride", 0xE6E6E6, of(new MaterialStack(Phosphorus, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Chlorine, 3)));
    ...
    public static final SimpleFluidMaterial Butanol = new SimpleFluidMaterial("butanol", (FermentedBiomass.materialRGB+20), of(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 10), new MaterialStack(Oxygen, 1)));
    ...
    public static final SimpleFluidMaterial FluoroBenzene = new SimpleFluidMaterial("fluoro_benzene", 0xD5D2D7, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 5), new MaterialStack(Fluorine, 1)));
    public static final SimpleFluidMaterial SodiumNitrateSolution = new SimpleFluidMaterial("sodium_nitrate_solution", 0xA09ED7, "NaNO3"+WATER.formulaGroup());
    public static final SimpleFluidMaterial Fluorotoluene = new SimpleFluidMaterial("fluorotoluene", 0xE0DA99, of(new MaterialStack(Carbon, 7), new MaterialStack(Hydrogen, 7), new MaterialStack(Fluorine, 1)));
    public static final SimpleFluidMaterial Xylene = new SimpleFluidMaterial("xylene", 0xB9575E, of(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 10)));
    public static final SimpleFluidMaterial XyleneZeoliteMixture = new SimpleFluidMaterial("xylene_zeolite", 0xB9785E, "C8H10(NaCa4Si27Al9(H2O)28O72)");
    ...
    public static final SimpleFluidMaterial Dibromomethylbenzene = new SimpleFluidMaterial("dibromomethylbenzene", 0x0A1D2C, of(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 8), new MaterialStack(Bromine, 2)));
    ...
    public static final SimpleFluidMaterial Pyridine = new SimpleFluidMaterial("pyridine", (Ammonia.materialRGB+Formaldehyde.rgb)/2, of(new MaterialStack(Carbon, 5), new MaterialStack(Hydrogen, 5), new MaterialStack(Nitrogen, 1)));
    public static final SimpleFluidMaterial Phenylpentanoicacid = new SimpleFluidMaterial("phenylpentanoicacid", (Butene.materialRGB+CarbonMonoxde.materialRGB)/2, of(new MaterialStack(Carbon, 11), new MaterialStack(Hydrogen, 14), new MaterialStack(Oxygen, 2)));
    public static final SimpleFluidMaterial Dimethylsulfide = new SimpleFluidMaterial("dimethylsulfide", (Methanol.materialRGB+HydrogenSulfide.materialRGB)/2, of(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 6), new MaterialStack(Sulfur, 1)));
    public static final SimpleFluidMaterial BenzoylChloride = new SimpleFluidMaterial("benzoyl_chloride", (Toluene.materialRGB+ThionylChloride.rgb)/2, of(new MaterialStack(Carbon, 7), new MaterialStack(Hydrogen, 5), new MaterialStack(Chlorine, 1), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial Silvertetrafluoroborate = new SimpleFluidMaterial("silvertetrafluoroborate", (SilverOxide.materialRGB+BoronFluoride.rgb)/2, of(new MaterialStack(Silver, 1), new MaterialStack(Boron, 1), new MaterialStack(Fluorine, 4)));
    ...
    public static final SimpleFluidMaterial Ferrocene = new SimpleFluidMaterial("ferrocene", (Water.materialRGB+Chlorine.materialRGB+Iron.materialRGB)/3, of(new MaterialStack(Iron, 1), new MaterialStack(Carbon, 10), new MaterialStack(Hydrogen, 10)));
    ...
    public static final SimpleFluidMaterial TannicAcid = new SimpleFluidMaterial("tannic_acid", (Diethylether.rgb+AcidifiedPolyphenolMix.rgb)/4, of(new MaterialStack(Carbon, 76), new MaterialStack(Hydrogen, 52), new MaterialStack(Oxygen, 46)));
    ...
    public static final SimpleFluidMaterial SodiumThiocyanate = new SimpleFluidMaterial("sodium_thiocyanate", (Sodium.materialRGB+Sulfur.materialRGB)/2, of(new MaterialStack(Sodium, 1), new MaterialStack(Sulfur, 1), new MaterialStack(Carbon, 1), new MaterialStack(Nitrogen, 1)));
    ...
    public static final SimpleFluidMaterial MethylFormate = new SimpleFluidMaterial("methyl_formate", 0Xff9999, of(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 4), new MaterialStack(Oxygen, 2)));
    public static final SimpleFluidMaterial WetFormamide = new SimpleFluidMaterial("wet_formamide", 0x33CCFF, of(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 3), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Water, 1)));
    public static final SimpleFluidMaterial Formamide = new SimpleFluidMaterial("formamide", 0x33CCFF, of(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 3), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial HydroxilamineDisulfate = new SimpleFluidMaterial("hydroxilamine_disulfate", 0x99add6, "(NH3OH)2SO4");
    public static final SimpleFluidMaterial Hydroxilamine = new SimpleFluidMaterial("hydroxilamine", 0x99cc99, of(new MaterialStack(Hydrogen, 3), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1)));
    public static final SimpleFluidMaterial Amidoxime = new SimpleFluidMaterial("amidoxime", 0x66ff33, "?");
    public static final SimpleFluidMaterial PureUranylNitrateSolution = new SimpleFluidMaterial("pure_uranyl_nitrate", 0x33bd45, "UO2(NO3)2");
    ...
    public static final SimpleFluidMaterial Trimethylamine = new SimpleFluidMaterial("trimetylamine", (Dimethylamine.materialRGB+20), of(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 9), new MaterialStack(Nitrogen, 1)));
    ...
    public static final SimpleFluidMaterial HotNitrogen = new SimpleFluidMaterial("hot_nitrogen", Nitrogen.materialRGB, of(new MaterialStack(Nitrogen, 1)));
    ...
    public static final SimpleFluidMaterial BismuthVanadateSolution = new SimpleFluidMaterial("bismuth_vanadate_solution",0xffff00); // TODO <- BOTTOM UP START HERE
    ...
    public static final SimpleFluidMaterial Metoxybenzaldehyde = new SimpleFluidMaterial("metoxybenzaldehyde",0x3c3a7a, "C8H8O2"); // TODO Methoxybenzaldehyde
    ...
    public static final SimpleFluidMaterial AcetylsulfanilideChloride = new SimpleFluidMaterial("acetylsulfanilide_chloride", (Aniline.rgb + AceticAnhydride.rgb + ChlorosulfuricAcid.rgb)/3, "C8H8ClNO3S"); // TODO Acetylsulfanilyl Chloride
    ...
    public static final SimpleFluidMaterial Iron2Chloride = new SimpleFluidMaterial("iron_ii_chloride", (IronChloride.materialRGB-30), of(new MaterialStack(Iron, 1), new MaterialStack(Chlorine, 2)));
    public static final SimpleFluidMaterial Propadiene = new SimpleFluidMaterial("propadiene", (Butanol.rgb-20), of(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 4)));
    ...
    public static final SimpleDustMaterial NaquadahConcentrate = new SimpleDustMaterial("naquadah_concentrate", Naquadah.materialRGB, (short) 3, Naquadah.materialIconSet, of(new MaterialStack(Naquadah, 1), new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial EnrichedNaquadahConcentrate = new SimpleDustMaterial("enriched_naquadah_concentrate", NaquadahEnriched.materialRGB, (short) 4, NaquadahEnriched.materialIconSet, of(new MaterialStack(NaquadahEnriched, 1), new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial NaquadriaConcentrate = new SimpleDustMaterial("naquadria_concentrate", Naquadria.materialRGB, (short) 5, Naquadria.materialIconSet, of(new MaterialStack(Naquadria, 1), new MaterialStack(RareEarth, 1)));
    ...
    public static final SimpleDustMaterial ThUSludge = new SimpleDustMaterial("thorium_uranium_sludge", 0x002908, (short) 7, MaterialIconSet.DULL, of(new MaterialStack(Thorium, 1), new MaterialStack(Uranium, 1)));
    ...
    public static final SimpleDustMaterial Yeast = new SimpleDustMaterial("yeast", 0xf0e660, (short) 26, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    ...
    public static final SimpleDustMaterial GreenAlgae = new SimpleDustMaterial("green_algae", 0x192b1b, (short) 32, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial BrownAlgae = new SimpleDustMaterial("brown_algae", 0x2b2519, (short) 33, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial RedAlgae = new SimpleDustMaterial("red_algae", 0x401313, (short) 34, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial DryRedAlgae = new SimpleDustMaterial("dry_red_algae", 0x8c1c1c, (short) 35, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial RedAlgaePowder = new SimpleDustMaterial("red_algae_powder", 0xcc2f2f, (short) 36, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial PreFreezeAgar = new SimpleDustMaterial("pre_freeze_agar", 0x132b0d, (short) 37, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial FrozenAgarCrystals = new SimpleDustMaterial("frozen_agar_crystals", 0x68db4b, (short) 38, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial Agar = new SimpleDustMaterial("agar", 0x38a31d, (short) 39, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    ...
    public static final SimpleDustMaterial LeadChloride = new SimpleDustMaterial("lead_chloride", (Lead.materialRGB+Chlorine.materialRGB)/2, (short) 53, MaterialIconSet.SHINY, of(new MaterialStack(Lead, 1), new MaterialStack(Chlorine, 2)));
    ...
    public static final SimpleDustMaterial PotassiumCyanide = new SimpleDustMaterial("potassium_cyanide", (Potassium.materialRGB+Nitrogen.materialRGB)/2, (short) 63, MaterialIconSet.DULL, of(new MaterialStack(Potassium, 1), new MaterialStack(Carbon, 1), new MaterialStack(Nitrogen, 1)));
    public static final SimpleDustMaterial SuccinicAcid = new SimpleDustMaterial("succinic_acid", (MaleicAnhydride.rgb+Water.materialRGB+Hydrogen.materialRGB)/3, (short) 64, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 6), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial Succinimide = new SimpleDustMaterial("succinimide", (SuccinicAcid.rgb+Ammonia.materialRGB)/2, (short) 65, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 5), new MaterialStack(NitrogenDioxide, 1)));
    public static final SimpleDustMaterial Bromosuccinimide = new SimpleDustMaterial("bromo_succinimide", (Succinimide.rgb+Bromine.materialRGB)/2, (short) 66, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 4), new MaterialStack(Bromine, 1), new MaterialStack(NitrogenDioxide, 1)));
    public static final SimpleDustMaterial Benzophenanthrenylacetonitrile = new SimpleDustMaterial("benzophenanthrenylacetonitrile", (Naphthaldehyde.rgb+Ethylene.materialRGB-20)/2, (short) 67, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 18), new MaterialStack(Hydrogen, 12)));
    public static final SimpleDustMaterial UnfoldedFullerene = new SimpleDustMaterial("unfolded_fullerene", (Benzophenanthrenylacetonitrile.rgb+Oxygen.materialRGB)/2, (short) 68, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 60)));
    public static final SimpleDustMaterial Fullerene = new SimpleDustMaterial("fullerene", (UnfoldedFullerene.rgb-20), (short) 69, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 60)));
    public static final SimpleDustMaterial TiAlChloride = new SimpleDustMaterial("tial_chloride", (Titanium.materialRGB+Aluminium.materialRGB+Chlorine.materialRGB)/3, (short) 70, MaterialIconSet.DULL, of(new MaterialStack(Titanium, 1), new MaterialStack(Aluminium, 1), new MaterialStack(Chlorine, 1)));
    public static final SimpleDustMaterial Dimethylaminopyridine = new SimpleDustMaterial("dimethylaminopyridine", (Dimethylamine.materialRGB+Pyridine.rgb)/2, (short) 71, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 7), new MaterialStack(Hydrogen, 10), new MaterialStack(Nitrogen, 2)));
    public static final SimpleDustMaterial PdIrReOCeOS = new SimpleDustMaterial("pdirreoceos", (Palladium.materialRGB+Iridium.materialRGB+Rhenium.materialRGB+Cerium.materialRGB+Osmium.materialRGB+Silicon.materialRGB+Oxygen.materialRGB)/7, (short) 72, MaterialIconSet.DULL, of(new MaterialStack(Palladium, 1), new MaterialStack(Iridium, 1), new MaterialStack(Rhenium, 1), new MaterialStack(Cerium, 1), new MaterialStack(Osmium, 1), new MaterialStack(Silicon, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial SodiumEthoxide = new SimpleDustMaterial("sodium_ethoxide", (Ethanol.materialRGB+ SodiumHydroxide.materialRGB)/2, (short) 73, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 5), new MaterialStack(Oxygen, 1), new MaterialStack(Sodium, 1)));
    public static final SimpleDustMaterial MgClBrominide = new SimpleDustMaterial("mgcl_bromide", (MagnesiumChloride.materialRGB+Bromine.materialRGB)/2, (short) 74, MaterialIconSet.DULL, of(new MaterialStack(MagnesiumChloride, 1), new MaterialStack(Bromine, 1)));
    public static final SimpleDustMaterial NMethylglicine = new SimpleDustMaterial("n_methylglicine", (Glycine.rgb+Oxygen.materialRGB)/2, (short) 75, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 7), new MaterialStack(NitrogenDioxide, 1)));
    public static final SimpleDustMaterial SodiumNitrite = new SimpleDustMaterial("sodium_nitrite", (Sodium.materialRGB+Nitrogen.materialRGB)/2, (short) 76, MaterialIconSet.DULL, of(new MaterialStack(Sodium, 1), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial ZnFeAlClCatalyst = new SimpleDustMaterial("znfealcl_catalyst", (Zinc.materialRGB+Iron.materialRGB+Aluminium.materialRGB+Chlorine.materialRGB)/4, (short) 77, MaterialIconSet.SHINY, of(new MaterialStack(Zinc, 1), new MaterialStack(Iron, 1), new MaterialStack(Aluminium, 1), new MaterialStack(Chlorine, 1)));
    public static final SimpleDustMaterial Difluorobenzophenone = new SimpleDustMaterial("difluorobenzophenone", (FluoroBenzene.rgb+Fluorotoluene.rgb)/2, (short) 78, MaterialIconSet.SHINY, of(new MaterialStack(Carbon, 13), new MaterialStack(Hydrogen, 8), new MaterialStack(Oxygen, 1), new MaterialStack(Fluorine, 2)));
    public static final SimpleDustMaterial AluminiumChloride = new SimpleDustMaterial("aluminium_chloride", (Aluminium.materialRGB+Chlorine.materialRGB)/2, (short) 79, MaterialIconSet.SHINY, of(new MaterialStack(Aluminium, 1), new MaterialStack(Chlorine, 3)));
    public static final SimpleDustMaterial PdFullereneMatrix = new SimpleDustMaterial("pd_fullerene_matrix", (Palladium.materialRGB+Fullerene.rgb)/2, (short) 80, MaterialIconSet.SHINY, of(new MaterialStack(Palladium, 1), new MaterialStack(Carbon, 60)));
    public static final SimpleDustMaterial Terephthalaldehyde = new SimpleDustMaterial("terephthalaldehyde", (Dibromomethylbenzene.rgb+SulfuricAcid.materialRGB)/2, (short) 81, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 6), new MaterialStack(Oxygen, 2)));
    ...
    public static final SimpleDustMaterial AuPdCCatalyst = new SimpleDustMaterial("aupdc_catalyst", (Gold.materialRGB+Palladium.materialRGB+Carbon.materialRGB)/3, (short) 83, MaterialIconSet.DULL, of(new MaterialStack(Gold, 1), new MaterialStack(Palladium, 1), new MaterialStack(Carbon, 1)));
    public static final SimpleDustMaterial Cyanonaphtalene = new SimpleDustMaterial("cyanonaphtalene", (SodiumCyanide.rgb+Naphtalene.materialRGB)/2, (short) 84, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 11), new MaterialStack(Hydrogen, 7), new MaterialStack(Nitrogen, 1)));
    public static final SimpleDustMaterial TinChloride = new SimpleDustMaterial("tin_chloride", (Tin.materialRGB+Chlorine.materialRGB)/2, (short) 85, MaterialIconSet.DULL, of(new MaterialStack(Tin, 1), new MaterialStack(Chlorine, 2)));
    public static final SimpleDustMaterial Triphenylphosphine = new SimpleDustMaterial("triphenylphosphine", (Chlorobenzene.materialRGB+PhosphorusChloride.rgb)/2, (short) 86, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 18), new MaterialStack(Hydrogen, 15), new MaterialStack(Phosphorus, 1)));
    public static final SimpleDustMaterial Methylbenzophenanthrene = new SimpleDustMaterial("methylbenzophenanthrene", (Naphthaldehyde.rgb+EthylBenzene.materialRGB)/2, (short) 87, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 19), new MaterialStack(Hydrogen, 14)));
    public static final SimpleDustMaterial VanadiumSlag = new SimpleDustMaterial("vanadium_slag", (Vanadium.materialRGB+Titanium.materialRGB)/2, (short) 88, MaterialIconSet.DULL, of(new MaterialStack(Vanadium, 1), new MaterialStack(Oxygen, 1), new MaterialStack(DarkAsh, 1), new MaterialStack(Rutile, 1)));
    ...
    public static final SimpleDustMaterial VanadiumOxide = new SimpleDustMaterial("vanadium_oxide", (Vanadium.materialRGB+Oxygen.materialRGB)/2, (short) 92, MaterialIconSet.SHINY, of(new MaterialStack(Vanadium, 2), new MaterialStack(Oxygen, 5)));
    ...
    public static final SimpleDustMaterial BariumCarbonate = new SimpleDustMaterial("barium_carbonate", (Barium.materialRGB+Oxygen.materialRGB+Carbon.materialRGB)/3, (short) 94, MaterialIconSet.DULL, of(new MaterialStack(Barium, 1), new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 3)));
    public static final SimpleDustMaterial BariumOxide = new SimpleDustMaterial("barium_oxide", (Barium.materialRGB+Oxygen.materialRGB)/2, (short) 95, MaterialIconSet.DULL, of(new MaterialStack(Barium, 1), new MaterialStack(Oxygen, 1)));
    public static final SimpleDustMaterial BariumAluminate = new SimpleDustMaterial("barium_aluminate", (Barium.materialRGB+Aluminium.materialRGB+Oxygen.materialRGB)/3, (short) 96, MaterialIconSet.DULL, of(new MaterialStack(Aluminium, 2), new MaterialStack(Barium, 1), new MaterialStack(Oxygen, 4)));
    ...
    public static final SimpleDustMaterial CesiumHydroxide = new SimpleDustMaterial("cesium_hydroxide", (Caesium.materialRGB+Oxygen.materialRGB+Hydrogen.materialRGB)/3, (short) 104, MaterialIconSet.DULL, of(new MaterialStack(Caesium, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Hydrogen, 1)));
    public static final SimpleDustMaterial AluminiumHydroxide = new SimpleDustMaterial("aluminium_hydroxide", (Aluminium.materialRGB+Hydrogen.materialRGB+Oxygen.materialRGB)/3, (short) 105, MaterialIconSet.DULL, of(new MaterialStack(Aluminium, 1), new MaterialStack(Oxygen, 3), new MaterialStack(Hydrogen, 3)));
    public static final SimpleDustMaterial PotassiumCarbonate = new SimpleDustMaterial("potassium_carbonate", (Potassium.materialRGB+Carbon.materialRGB+Oxygen.materialRGB)/3, (short) 106, MaterialIconSet.DULL, of(new MaterialStack(Potassium, 2), new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 3)));
    ...
    public static final SimpleDustMaterial NiAlOCatalyst = new SimpleDustMaterial("nialo_catalyst", 0x0af0af, (short) 108, MaterialIconSet.DULL, of(new MaterialStack(Nickel, 1), new MaterialStack(Aluminium, 1), new MaterialStack(Oxygen, 1)));
    ...
    public static final SimpleDustMaterial LithiumChloride = new SimpleDustMaterial("lithium_chloride", (Lithium.materialRGB+Chlorine.materialRGB)/2, (short) 112, MaterialIconSet.DULL, of(new MaterialStack(Lithium, 1), new MaterialStack(Chlorine, 1)));
    ...
    public static final SimpleDustMaterial PotassiumSulfate = new SimpleDustMaterial("potassium_sulfate", (Potassium.materialRGB+Sulfur.materialRGB)/2, (short) 115, MaterialIconSet.DULL, of(new MaterialStack(Potassium, 2), new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial AluminiumSulfate = new SimpleDustMaterial("aluminium_sulfate", (Aluminium.materialRGB+Sulfur.materialRGB)/2, (short) 116, MaterialIconSet.DULL, of(new MaterialStack(Aluminium, 2), new MaterialStack(Sulfur, 3), new MaterialStack(Oxygen, 12)));
    public static final SimpleDustMaterial BariumHydroxide = new SimpleDustMaterial("barium_hydroxide", (Barium.materialRGB+Hydrogen.materialRGB+Oxygen.materialRGB)/3, (short) 117, MaterialIconSet.DULL, of(new MaterialStack(Barium, 1), new MaterialStack(Oxygen, 2), new MaterialStack(Hydrogen, 2)));
    ...
    public static final SimpleDustMaterial SiliconChloride = new SimpleDustMaterial("silicon_chloride", (Silicon.materialRGB+Chlorine.materialRGB)/2, (short) 119, MaterialIconSet.DULL, of(new MaterialStack(Silicon, 1), new MaterialStack(Chlorine, 4)));
    ...
    public static final SimpleDustMaterial ZincCokePellets = new SimpleDustMaterial("zinc_coke_pellets", (Zinc.materialRGB+Coke.materialRGB)/2, (short) 121, MaterialIconSet.DULL, of(new MaterialStack(Sphalerite, 1), new MaterialStack(Coke, 1), new MaterialStack(DistilledWater, 1)));
    public static final SimpleDustMaterial ZincResidualSlag = new SimpleDustMaterial("zinc_residual_slag", (Zinc.materialRGB-20), (short) 122, MaterialIconSet.DULL, of(new MaterialStack(RareEarth, 1)));
    ...
    public static final SimpleDustMaterial ZincLeachingResidue = new SimpleDustMaterial("zinc_leaching_residue", (Germanium.materialRGB+Oxygen.materialRGB)/2, (short) 124, MaterialIconSet.DULL, of(new MaterialStack(Germanium, 1), new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial FineZincSlagDust = new SimpleDustMaterial("fine_zinc_slag_dust", (Zinc.materialRGB-10), (short) 125, MaterialIconSet.FINE, of(new MaterialStack(RareEarth, 1)));
    ...
    public static final SimpleDustMaterial Cellulose = new SimpleDustMaterial("cellulose", (0xfefefc), (short) 132, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 10), new MaterialStack(Oxygen, 5)));
    ...
    public static final SimpleDustMaterial SodiumAzanide = new SimpleDustMaterial("sodium_azanide", (Sodium.materialRGB+Hydrogen.materialRGB+Nitrogen.materialRGB)/3, (short) 143, MaterialIconSet.DULL, of(new MaterialStack(Sodium, 1), new MaterialStack(Nitrogen, 1), new MaterialStack(Hydrogen, 2)));
    public static final SimpleDustMaterial SodiumAzide = new SimpleDustMaterial("sodium_azide", (Sodium.materialRGB+Nitrogen.materialRGB)/2, (short) 144, MaterialIconSet.DULL, of(new MaterialStack(Sodium, 1), new MaterialStack(Nitrogen, 3)));
    public static final SimpleDustMaterial Glucosamine = new SimpleDustMaterial("glucosamine", (Cellulose.rgb+Water.materialRGB)/2, (short) 145, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 13), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 5)));
    ...
    public static final SimpleDustMaterial Fructose = new SimpleDustMaterial("fructose", (Cellulose.rgb+Sugar.materialRGB)/2, (short) 165, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 12), new MaterialStack(Oxygen, 6)));
    public static final SimpleDustMaterial Glucose = new SimpleDustMaterial("glucose", (Sugar.materialRGB+5), (short) 166, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 12), new MaterialStack(Oxygen, 6)));
    ...
    public static final SimpleDustMaterial ManganeseSulfate = new SimpleDustMaterial("manganese_sulfate", (Manganese.materialRGB+Sulfur.materialRGB)/2, (short) 176, MaterialIconSet.DULL, of(new MaterialStack(Manganese, 1), new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 4)));
    ...
    public static final SimpleDustMaterial NiobiumTantalumOxide = new SimpleDustMaterial("niobium_tantalum_oxide", (Niobium.materialRGB+Tantalum.materialRGB)/2, (short) 179, MaterialIconSet.SHINY, of(new MaterialStack(Niobium, 2), new MaterialStack(Oxygen, 5), new MaterialStack(Tantalum, 2), new MaterialStack(Oxygen, 5)));
    public static final SimpleDustMaterial FusedColumbite = new SimpleDustMaterial("fused_columbite", 0xCCCC00, (short) 180, MaterialIconSet.DULL, of(new MaterialStack(BandedIron, 1), new MaterialStack(Niobium, 2), new MaterialStack(Oxygen, 5), new MaterialStack(Sodium, 2), new MaterialStack(Oxygen, 1)));
    public static final SimpleDustMaterial LeachedColumbite = new SimpleDustMaterial("leached_columbite", 0xCCCC00, (short) 181, MaterialIconSet.SHINY, of(new MaterialStack(Tantalum, 2), new MaterialStack(Oxygen, 5), new MaterialStack(Niobium, 18), new MaterialStack(Oxygen, 45), new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial FusedTantalite = new SimpleDustMaterial("fused_tantalite", 0x915028, (short) 182, MaterialIconSet.DULL, of(new MaterialStack(BandedIron, 1), new MaterialStack(Tantalum, 2), new MaterialStack(Oxygen, 5), new MaterialStack(Sodium, 2), new MaterialStack(Oxygen, 1)));
    ...
    public static final SimpleDustMaterial AcidicLeachedPyrochlore = new SimpleDustMaterial("acidic_leached_pyrochlore", 0x996633, (short) 187, MaterialIconSet.SHINY, of(new MaterialStack(Pyrochlore, 1), new MaterialStack(SulfuricAcid, 1)));
    ...
    public static final SimpleDustMaterial BariumPeroxide = new SimpleDustMaterial("barium_peroxide", (Barium.materialRGB+Oxygen.materialRGB-30)/2, (short) 190, MaterialIconSet.DULL, of(new MaterialStack(Barium, 1), new MaterialStack(Oxygen, 2)));
    ...
    public static final SimpleDustMaterial SodiumBicarbonate = new SimpleDustMaterial("sodium_bicarbonate", (Sodium.materialRGB+Hydrogen.materialRGB+Carbon.materialRGB)/3, (short) 194, MaterialIconSet.DULL, of(new MaterialStack(Sodium, 1), new MaterialStack(Hydrogen, 1), new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 3)));
    ...
    public static final SimpleDustMaterial DehydratedLignite = new SimpleDustMaterial("dehydrated_lignite", 0x5c4020, (short) 196, MaterialIconSet.DULL, of(new MaterialStack(Lignite, 1), new MaterialStack(RareEarth, 1)));
    public static final SimpleDustMaterial BCEPellet = new SimpleDustMaterial("bce_pellet", 0x3c3020, (short) 197, MaterialIconSet.LIGNITE, of(new MaterialStack(Lignite, 1)));
    public static final SimpleDustMaterial CopperGalliumIndiumMix = new SimpleDustMaterial("copper_gallium_indium_mix", (Indium.materialRGB + Copper.materialRGB + Gallium.materialRGB) / 3, (short) 198, MaterialIconSet.DULL, of(new MaterialStack(Copper, 1), new MaterialStack(Gallium, 1), new MaterialStack(Indium, 1)));
    public static final SimpleDustMaterial CopperGalliumIndiumSelenide = new SimpleDustMaterial("copper_gallium_indium_selenide", (CopperGalliumIndiumMix.rgb + Selenium.materialRGB) / 2, (short) 199, MaterialIconSet.DULL, of(new MaterialStack(Copper, 1), new MaterialStack(Gallium, 1), new MaterialStack(Indium, 1), new MaterialStack(Hydrogen, 2), new MaterialStack(Selenium, 1)));
    public static final SimpleDustMaterial LanthanumCalciumManganate = new SimpleDustMaterial("lanthanum_gallium_manganate", 0x8aa07b, (short) 200, MaterialIconSet.DULL, of(new MaterialStack(Lanthanum, 1), new MaterialStack(Calcium, 1), new MaterialStack(Manganese, 1), new MaterialStack(Oxygen, 3)));
    public static final SimpleDustMaterial AluminiumComplex = new SimpleDustMaterial("aluminium_complex", 0x3f5a9f, (short) 201, MaterialIconSet.DULL, of(new MaterialStack(Aluminium, 1), new MaterialStack(Carbon, 9), new MaterialStack(Hydrogen, 7), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1)));
    ...
    public static final SimpleDustMaterial YttriumNitrate = new SimpleDustMaterial("yttrium_nitrate", 0xdadafc, (short) 206, MaterialIconSet.SHINY, of(new MaterialStack(Yttrium, 1), new MaterialStack(Nitrogen, 3), new MaterialStack(Oxygen, 9)));
    public static final SimpleDustMaterial CopperNitrate = new SimpleDustMaterial("copper_nitrate", 0xcaecec, (short) 254, MaterialIconSet.SHINY, of(new MaterialStack(Copper, 1), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 6)));
    public static final SimpleDustMaterial BariumNitrate = new SimpleDustMaterial("barium_nitrate", (Barium.materialRGB+Nitrogen.materialRGB+Oxygen.materialRGB)/3, (short) 207, MaterialIconSet.SHINY, of(new MaterialStack(Barium, 1), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 6)));
    public static final SimpleDustMaterial WellMixedYBCOxides = new SimpleDustMaterial("well_mixed_ybc_oxides", 0x2c3429, (short) 208, MaterialIconSet.DULL, of(new MaterialStack(Yttrium, 1), new MaterialStack(Barium, 2), new MaterialStack(Copper, 3), new MaterialStack(Oxygen, 6)));
    public static final SimpleDustMaterial PiledTBCC = new SimpleDustMaterial("piled_tbcc", 0x669900, (short) 209, MaterialIconSet.SHINY, of(new MaterialStack(Thallium, 2), new MaterialStack(Barium, 2), new MaterialStack(Copper, 3), new MaterialStack(Calcium, 2)));
    public static final SimpleDustMaterial ActiniumOxalate = new SimpleDustMaterial("actinium_oxalate", Actinium.materialRGB, (short) 210, MaterialIconSet.SHINY, of(new MaterialStack(Actinium, 1), new MaterialStack(Carbon, 4), new MaterialStack(Oxygen, 8)));
    public static final SimpleDustMaterial ActiniumHydride = new SimpleDustMaterial("actinium_hydride", Actinium.materialRGB, (short) 211, MaterialIconSet.SHINY, of(new MaterialStack(Actinium, 1), new MaterialStack(Hydrogen, 3)));
    ...
    public static final SimpleDustMaterial IronIodide = new SimpleDustMaterial("iron_iodide", (Iron.materialRGB+Iodine.materialRGB)/2, (short) 214, MaterialIconSet.DULL, of(new MaterialStack(Iron, 1), new MaterialStack(Iodine, 2)));
    public static final SimpleDustMaterial PotassiumIodide = new SimpleDustMaterial("potassium_iodide", (Potassium.materialRGB+Iodine.materialRGB)/2, (short) 215, MaterialIconSet.DULL, of(new MaterialStack(Potassium, 1), new MaterialStack(Iodine, 1)));
    public static final SimpleDustMaterial ThalliumIodide = new SimpleDustMaterial("thallium_iodide", (Thallium.materialRGB+Iodine.materialRGB)/2, (short) 216, MaterialIconSet.DULL, of(new MaterialStack(Thallium, 1), new MaterialStack(Iodine, 1)));
    public static final SimpleDustMaterial ScandiumIodide = new SimpleDustMaterial("scandium_iodide", (Scandium.materialRGB+Iodine.materialRGB)/2, (short) 217, MaterialIconSet.DULL, of(new MaterialStack(Scandium, 1), new MaterialStack(Iodine, 3)));
    public static final SimpleDustMaterial RubidiumIodide = new SimpleDustMaterial("rubidium_iodide", (Rubidium.materialRGB+Iodine.materialRGB)/2, (short) 218, MaterialIconSet.DULL, of(new MaterialStack(Rubidium, 1), new MaterialStack(Iodine, 1)));
    public static final SimpleDustMaterial IndiumIodide = new SimpleDustMaterial("indium_iodide", (Indium.materialRGB+Iodine.materialRGB)/2, (short) 219, MaterialIconSet.DULL, of(new MaterialStack(Indium, 1), new MaterialStack(Iodine, 3)));
    public static final SimpleDustMaterial GalliumIodide = new SimpleDustMaterial("gallium_iodide", (Gallium.materialRGB+Iodine.materialRGB)/2, (short) 220, MaterialIconSet.DULL, of(new MaterialStack(Gallium, 1), new MaterialStack(Iodine, 3)));
    ...
    public static final SimpleDustMaterial SodiumPeriodate = new SimpleDustMaterial("sodium_periodate", 0x11116d, (short) 238, MaterialIconSet.DULL, of(new MaterialStack(Sodium, 1), new MaterialStack(Iodine, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial SodiumSeaborgate = new SimpleDustMaterial("sodium_seaborgate", 0x55bbd4, (short) 239, MaterialIconSet.SHINY, of(new MaterialStack(Sodium, 1), new MaterialStack(Seaborgium, 1), new MaterialStack(Oxygen, 3)));
    public static final SimpleDustMaterial OsmiumTetroxide = new SimpleDustMaterial("osmium_tetroxide", 0x82cbd6, (short) 240, MaterialIconSet.SHINY, of(new MaterialStack(Osmium, 1), new MaterialStack(Oxygen, 4)));
    ...
    public static final SimpleDustMaterial YttriumEuropiumVanadate = new SimpleDustMaterial("yttrium_europium_vanadate", (Yttrium.materialRGB+ Europium.materialRGB+Vanadium.materialRGB)/3, (short) 242, MaterialIconSet.DULL, of(new MaterialStack(Yttrium, 1), new MaterialStack(Europium, 1), new MaterialStack(Vanadium, 4), new MaterialStack(Oxygen, 4)));
    ...
    public static final SimpleDustMaterial BariumStrontiumTitanate = new SimpleDustMaterial("barium_strontium_titanate", 0xFF0066, (short) 244, MaterialIconSet.SHINY, of(new MaterialStack(Barium, 1), new MaterialStack(Oxygen, 6), new MaterialStack(Strontium, 1), new MaterialStack(Titanium, 2)));
    public static final SimpleDustMaterial PotassiumManganate = new SimpleDustMaterial("potassium_manganate", 0xaf20af, (short) 246, MaterialIconSet.DULL, of(new MaterialStack(Potassium, 2), new MaterialStack(Manganese, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial BariumChloride = new SimpleDustMaterial("barium_chloride", (Barium.materialRGB+Chlorine.materialRGB)/2, (short) 247, MaterialIconSet.DULL, of(new MaterialStack(Barium, 1), new MaterialStack(Chlorine, 2)));
    public static final SimpleDustMaterial TantalumOxide = new SimpleDustMaterial("tantalum_oxide", (Tantalum.materialRGB+Oxygen.materialRGB)/2, (short) 248, MaterialIconSet.SHINY, of(new MaterialStack(Tantalum, 2), new MaterialStack(Oxygen, 5)));
    public static final SimpleDustMaterial ZirconylChloride = new SimpleDustMaterial("zirconyl_chloride", ZirconiumTetrachloride.rgb, (short) 249, MaterialIconSet.DULL, of(new MaterialStack(Zirconium, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Chlorine, 2)));
    public static final SimpleDustMaterial LeadSenenide = new SimpleDustMaterial("lead_selenide", (Lead.materialRGB+Selenium.materialRGB)/2, (short) 250, MaterialIconSet.DULL, of(new MaterialStack(Lead, 1), new MaterialStack(Selenium, 1)));
    public static final SimpleDustMaterial LeadScandiumTantalate = new SimpleDustMaterial("lead_scandium_tantalate", (Lead.materialRGB+Scandium.materialRGB+Tantalum.materialRGB)/3, (short) 251, MaterialIconSet.SHINY, of(new MaterialStack(Lead, 1), new MaterialStack(Scandium, 2), new MaterialStack(Tantalum, 1), new MaterialStack(Oxygen, 3)));
    ...
    public static final SimpleDustMaterial BoronOxide = new SimpleDustMaterial("boron_oxide",(Boron.materialRGB+Oxygen.materialRGB)/2,(short) 256,MaterialIconSet.DULL, of(new MaterialStack(Boron, 2), new MaterialStack(Oxygen, 3)));
    ...
    public static final SimpleDustMaterial PotassiumPermanganate = new SimpleDustMaterial("potassium_permanganate",0xaf20af,(short) 270,MaterialIconSet.DULL, of(new MaterialStack(Potassium, 1), new MaterialStack(Manganese, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial Urea = new SimpleDustMaterial("urea",0x30cf20,(short) 271,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 4), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 1)));
    public static final SimpleDustMaterial CesiumBromide = new SimpleDustMaterial("cesium_bromide", CesiumHydroxide.rgb, (short) 272,MaterialIconSet.DULL, of(new MaterialStack(Caesium, 1), new MaterialStack(Bromine, 1)));
    ...
    public static final SimpleDustMaterial AmmoniumBifluoride = new SimpleDustMaterial("ammonium_bifluoride",0x20cfcf,(short) 276,MaterialIconSet.DULL, of(new MaterialStack(Nitrogen, 1), new MaterialStack(Hydrogen, 5), new MaterialStack(Fluorine, 2)));
    public static final SimpleDustMaterial SodiumArsenate = new SimpleDustMaterial("sodium_arsenate",0xbffabf,(short) 277,MaterialIconSet.DULL, of(new MaterialStack(Sodium, 3), new MaterialStack(Arsenic, 1), new MaterialStack(Oxygen, 4)));
    ...
    public static final SimpleDustMaterial PureSodiumVanadate = new SimpleDustMaterial("pure_sodium_vanadate", SodiumVanadate.rgb, (short) 280,MaterialIconSet.DULL, of(new MaterialStack(Sodium, 3), new MaterialStack(Vanadium, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial AmmoniumCarbonate = new SimpleDustMaterial("ammonium_carbonate", AmmoniumSulfate.rgb, (short) 281,MaterialIconSet.DULL, of(new MaterialStack(Nitrogen, 2), new MaterialStack(Hydrogen, 8), new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 3)));
    public static final SimpleDustMaterial CadmiumSulfide = new SimpleDustMaterial("cadmium_sulfide",0xffff00,(short) 282,MaterialIconSet.DULL, of(new MaterialStack(Cadmium, 1), new MaterialStack(Sulfur, 1)));
    ...
    public static final SimpleDustMaterial BismuthVanadate = new SimpleDustMaterial("bismuth_vanadate",0xffff00,(short) 286,MaterialIconSet.DULL, of(new MaterialStack(Bismuth, 1), new MaterialStack(Vanadium, 1), new MaterialStack(Oxygen, 4)));
    ...
    public static final SimpleDustMaterial MercuryIodide = new SimpleDustMaterial("mercury_iodide",0xff0000,(short) 288,MaterialIconSet.DULL, of(new MaterialStack(Mercury, 1), new MaterialStack(Iodine, 2)));
    ...
    public static final SimpleDustMaterial ScheelesGreen = new SimpleDustMaterial("scheeles_green",0x00ff00,(short) 291,MaterialIconSet.DULL, of(new MaterialStack(Arsenic, 1), new MaterialStack(Copper, 1), new MaterialStack(Hydrogen, 1), new MaterialStack(Oxygen, 3)));
    ...
    public static final SimpleDustMaterial ChromeOrange = new SimpleDustMaterial("chrome_orange",0xff6600,(short) 298,MaterialIconSet.DULL, of(new MaterialStack(Lead, 2), new MaterialStack(Chrome, 1), new MaterialStack(Oxygen, 5)));
    ...
    public static final SimpleDustMaterial Nigrosin = new SimpleDustMaterial("nigrosin",0x000000,(short) 300,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 30), new MaterialStack(Hydrogen, 23), new MaterialStack(Nitrogen, 5)));
    public static final SimpleDustMaterial DirectBrown = new SimpleDustMaterial("direct_brown",0x663300,(short) 301,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 26), new MaterialStack(Hydrogen, 19), new MaterialStack(Nitrogen, 6), new MaterialStack(Sodium, 1), new MaterialStack(Oxygen, 3), new MaterialStack(Sulfur, 1)));
    ...
    public static final SimpleDustMaterial DiarylideYellow = new SimpleDustMaterial("diarylide_yellow",0xffff00,(short) 304,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 36), new MaterialStack(Hydrogen, 34), new MaterialStack(Chlorine, 2), new MaterialStack(Nitrogen, 6), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial AlizarineCyanineGreen = new SimpleDustMaterial("alizarine_cyanine_green",0x00ff00,(short) 305,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 28), new MaterialStack(Hydrogen, 20), new MaterialStack(Nitrogen, 2), new MaterialStack(Sodium, 2), new MaterialStack(Oxygen, 8), new MaterialStack(Sulfur, 2)));
    public static final SimpleDustMaterial Aminoanthraquinone = new SimpleDustMaterial("aminoanthraquinone",0x0000ff,(short) 306,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 14), new MaterialStack(Hydrogen, 9), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial IndathroneBlue = new SimpleDustMaterial("indathrone_blue",0x0000ff,(short) 307,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 28), new MaterialStack(Hydrogen, 14), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2))); // TODO Wrong name
    public static final SimpleDustMaterial Diketopyrrolopyrrole = new SimpleDustMaterial("diketopyrrolopyrrole",0xff6600,(short) 308,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 2), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial Mauvine = new SimpleDustMaterial("mauvine",0x660066,(short) 309,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 26), new MaterialStack(Hydrogen, 23), new MaterialStack(Nitrogen, 4))); // TODO Wrong name
    public static final SimpleDustMaterial Indigo = new SimpleDustMaterial("indigo",0x0000ff,(short) 310,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 16), new MaterialStack(Hydrogen, 10), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial Tetrabromoindigo = new SimpleDustMaterial("tetrabromoindigo",0x00ff00,(short) 311,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 16), new MaterialStack(Hydrogen, 6), new MaterialStack(Bromine, 2), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 2)));
    ...
    public static final SimpleDustMaterial Fluorescein = new SimpleDustMaterial("fluorescein",0x990000,(short) 313,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 20), new MaterialStack(Hydrogen, 12), new MaterialStack(Oxygen, 5)));
    public static final SimpleDustMaterial Erythrosine = new SimpleDustMaterial("erythrosine",0xff00ff,(short) 314,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 20), new MaterialStack(Hydrogen, 6), new MaterialStack(Iodine, 4), new MaterialStack(Sodium, 2), new MaterialStack(Oxygen, 5)));
    ...
    public static final SimpleDustMaterial MercuryChloride = new SimpleDustMaterial("mercury_chloride",0xd6b8ad,(short) 316,MaterialIconSet.DULL, of(new MaterialStack(Mercury, 1), new MaterialStack(Chlorine, 2)));
    ...
    public static final SimpleDustMaterial Anthraquinone = new SimpleDustMaterial("anthraquinone",0xfff782,(short) 320,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 14), new MaterialStack(Hydrogen, 8), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial LithiumHydride = new SimpleDustMaterial("lithium_hydride",(Lithium.materialRGB+Hydrogen.materialRGB)/2,(short) 321,MaterialIconSet.DULL, of(new MaterialStack(Lithium, 1), new MaterialStack(Hydrogen, 1)));
    ...
    public static final SimpleDustMaterial LithiumHydroxide = new SimpleDustMaterial("lithium_hydroxide", (Lithium.materialRGB+Oxygen.materialRGB+Hydrogen.materialRGB)/3, (short) 327, MaterialIconSet.DULL, of(new MaterialStack(Lithium, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Hydrogen, 1)));
    ...
    public static final SimpleDustMaterial FranciumCaesiumCadmiumBromide = new SimpleDustMaterial("francium_caesium_cadmium_bromide",(Francium.materialRGB+Caesium.materialRGB+Cadmium.materialRGB+Bromine.materialRGB)/4,(short) 330,MaterialIconSet.DULL, of(new MaterialStack(Francium, 1), new MaterialStack(Caesium, 1), new MaterialStack(Cadmium, 2), new MaterialStack(Bromine, 6)));
    public static final SimpleDustMaterial ZincSelenide = new SimpleDustMaterial("zinc_selenide",0xfcfc00,(short) 331,MaterialIconSet.DULL, of(new MaterialStack(Zinc, 1), new MaterialStack(Selenium, 1)));
    public static final SimpleDustMaterial RhodamineB = new SimpleDustMaterial("rhodamine_b",0xfc2020,(short) 332,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 28), new MaterialStack(Hydrogen, 31), new MaterialStack(Chlorine, 1), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 3)));
    public static final SimpleDustMaterial Stibene = new SimpleDustMaterial("stibene",0x3c9c3c,(short) 333,MaterialIconSet.DULL, "C14H12");
    public static final SimpleDustMaterial Tetracene = new SimpleDustMaterial("tetracene",0x99801a,(short) 334,MaterialIconSet.SHINY, of(new MaterialStack(Carbon, 18), new MaterialStack(Hydrogen, 12)));
    public static final SimpleDustMaterial DitertbutylCarbonate = new SimpleDustMaterial("ditertbutyl_carbonate",0xccccf6,(short) 335, MaterialIconSet.DULL, of(new MaterialStack(Carbon, 10), new MaterialStack(Hydrogen, 18), new MaterialStack(Oxygen, 5)));
    public static final SimpleDustMaterial PotassiumBromide = new SimpleDustMaterial("potassium_bromide",0xe066a3,(short) 336,MaterialIconSet.DULL, of(new MaterialStack(Potassium, 1), new MaterialStack(Bromine, 1)));
    public static final SimpleDustMaterial PotassiumBromate = new SimpleDustMaterial("potassium_bromate",0x8a4cd1,(short) 337,MaterialIconSet.DULL, of(new MaterialStack(Potassium, 1), new MaterialStack(Bromine, 1), new MaterialStack(Oxygen, 3)));
    public static final SimpleDustMaterial IBX = new SimpleDustMaterial("ibx",0x20208c,(short) 338,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 7), new MaterialStack(Hydrogen, 5), new MaterialStack(Iodine, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial SodiumPertechnate = new SimpleDustMaterial("sodium_pertechnate",0x6162c4,(short) 339,MaterialIconSet.SHINY, of(new MaterialStack(Sodium, 1), new MaterialStack(Technetium, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial PotassiumPertechnate = new SimpleDustMaterial("potassium_pertechnate",0xdec451,(short) 340,MaterialIconSet.SHINY, of(new MaterialStack(Potassium, 1), new MaterialStack(Technetium, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial PotassiumPerrhenate = new SimpleDustMaterial("potassium_perrhenate",0xdec451,(short) 341,MaterialIconSet.SHINY, of(new MaterialStack(Potassium, 1), new MaterialStack(Rhenium, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial PotassiumNonahydridotechnate = new SimpleDustMaterial("potassium_nonahydridotechnate",0xeee2a8,(short) 342,MaterialIconSet.SHINY, of(new MaterialStack(Potassium, 2), new MaterialStack(Technetium, 1), new MaterialStack(Hydrogen, 9)));
    public static final SimpleDustMaterial PotassiumNonahydridorhenate = new SimpleDustMaterial("potassium_nonahydridorhenate",0xeee2a8,(short) 343,MaterialIconSet.SHINY, of(new MaterialStack(Potassium, 2), new MaterialStack(Rhenium, 1), new MaterialStack(Hydrogen, 9)));
    public static final SimpleDustMaterial LithiumIodide = new SimpleDustMaterial("lithium_iodide",(Lithium.materialRGB+Iodine.materialRGB),(short) 344,MaterialIconSet.DULL, of(new MaterialStack(Lithium, 1), new MaterialStack(Iodine, 1)));
    ...
    public static final SimpleDustMaterial SaccharicAcid = new SimpleDustMaterial("saccharic_acid",Glucose.rgb,(short) 346,MaterialIconSet.DULL, of(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 10), new MaterialStack(Oxygen, 8)));
    ...
    public static final SimpleDustMaterial GermaniumSulfide = new SimpleDustMaterial("germanium_sulfide",GermaniumOxide.rgb,(short) 350,MaterialIconSet.DULL, of(new MaterialStack(Germanium, 1), new MaterialStack(Sulfur, 2)));
    public static final SimpleDustMaterial BismuthGermanate = new SimpleDustMaterial("bismuth_germanate",0x94cf5c,(short) 351,MaterialIconSet.DULL, of(new MaterialStack(Bismuth, 12), new MaterialStack(Germanium, 1), new MaterialStack(Oxygen, 20)));
    public static final SimpleDustMaterial CesiumIodide = new SimpleDustMaterial("cesium_iodide",CesiumBromide.rgb,(short) 352, MaterialIconSet.DULL, of(new MaterialStack(Caesium, 1), new MaterialStack(Iodine, 1)));
    ...
    public static final SimpleDustMaterial CadmiumTungstate = new SimpleDustMaterial("cadmium_tungstate",CalciumTungstate.materialRGB,(short) 354,MaterialIconSet.DULL, of(new MaterialStack(Cadmium, 1), new MaterialStack(Tungsten, 1), new MaterialStack(Oxygen, 4)));
    ...
    public static final SimpleDustMaterial SodiumPerchlorate = new SimpleDustMaterial("sodium_perchlorate", Salt.materialRGB,(short) 376, MaterialIconSet.DULL, of(new MaterialStack(Sodium, 1), new MaterialStack(Chlorine, 1), new MaterialStack(Oxygen, 4)));
    ...
    public static final SimpleDustMaterial PotassiumPeroxymonosulfate = new SimpleDustMaterial("potassium_peroxymonosulfate", (PotassiumMetabisulfite.materialRGB + 20), (short) 374, MaterialIconSet.DULL, of(new MaterialStack(Potassium, 1), new MaterialStack(Hydrogen, 1), new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 5)));
    ...
    public static final SimpleDustMaterial SilverPerchlorate = new SimpleDustMaterial("silver_perchlorate", SilverChloride.materialRGB, (short) 902, MaterialIconSet.DULL, of(new MaterialStack(Silver, 1), new MaterialStack(Chlorine, 1), new MaterialStack(Oxygen, 4)));
    public static final SimpleDustMaterial SodiumChlorate = new SimpleDustMaterial("sodium_chlorate", Salt.materialRGB, (short) 901, MaterialIconSet.DULL, of(new MaterialStack(Sodium, 1), new MaterialStack(Chlorine, 1), new MaterialStack(Oxygen, 3)));
    public static final SimpleDustMaterial LeadSulfate = new SimpleDustMaterial("lead_sulfate", Lead.materialRGB+LeadNitrate.materialRGB/2, (short) 375, MaterialIconSet.DULL, of(new MaterialStack(Lead, 1), new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 4)));
