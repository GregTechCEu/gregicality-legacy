...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final IngotMaterial UMVSuperconductor = new IngotMaterial(724, "umv_superconductor", 0x883afc, MaterialIconSet.SHINY, 1, of(), DISABLE_DECOMPOSITION | DISABLE_AUTOGENERATED_MIXER_RECIPE);
    ...
    public static final IngotMaterial UXVSuperconductor = new IngotMaterial(722, "uxv_superconductor", 0xe34b5a, MaterialIconSet.SHINY, 1, of(), DISABLE_DECOMPOSITION | DISABLE_AUTOGENERATED_MIXER_RECIPE);
    ...
    public static final SimpleDustMaterial LanthanumOxide = new SimpleDustMaterial("lanthanum_oxide", Lanthanum.materialRGB, (short) 8, Lanthanum.materialIconSet, of(new MaterialStack(Lanthanum, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial PraseodymiumOxide = new SimpleDustMaterial("praseodymium_oxide", Praseodymium.materialRGB, (short) 9, Praseodymium.materialIconSet, of(new MaterialStack(Praseodymium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial NeodymiumOxide = new SimpleDustMaterial("neodymium_oxide", Neodymium.materialRGB, (short) 10, Neodymium.materialIconSet, of(new MaterialStack(Neodymium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial CeriumOxide = new SimpleDustMaterial("cerium_oxide", Cerium.materialRGB, (short) 11, Cerium.materialIconSet, of(new MaterialStack(Cerium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial EuropiumOxide = new SimpleDustMaterial("europium_oxide", Europium.materialRGB, (short) 12, Europium.materialIconSet, of(new MaterialStack(Europium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial GadoliniumOxide = new SimpleDustMaterial("gadolinium_oxide", Gadolinium.materialRGB, (short) 13, Gadolinium.materialIconSet, of(new MaterialStack(Gadolinium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial SamariumOxide = new SimpleDustMaterial("samarium_oxide", Samarium.materialRGB, (short) 14, Samarium.materialIconSet, of(new MaterialStack(Samarium, 1), new MaterialStack(Oxygen, 2)));
    ...
    public static final SimpleDustMaterial TerbiumOxide = new SimpleDustMaterial("terbium_oxide", Terbium.materialRGB, (short) 15, Terbium.materialIconSet, of(new MaterialStack(Terbium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial DysprosiumOxide = new SimpleDustMaterial("dysprosium_oxide", Dysprosium.materialRGB, (short) 16, Dysprosium.materialIconSet, of(new MaterialStack(Dysprosium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial HolmiumOxide = new SimpleDustMaterial("holmium_oxide", Holmium.materialRGB, (short) 17, Holmium.materialIconSet, of(new MaterialStack(Holmium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial ErbiumOxide = new SimpleDustMaterial("erbium_oxide", Erbium.materialRGB, (short) 18, Erbium.materialIconSet, of(new MaterialStack(Erbium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial ThuliumOxide = new SimpleDustMaterial("thulium_oxide", Thulium.materialRGB, (short) 19, Thulium.materialIconSet, of(new MaterialStack(Thulium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial YtterbiumOxide = new SimpleDustMaterial("ytterbium_oxide", Ytterbium.materialRGB, (short) 20, Ytterbium.materialIconSet, of(new MaterialStack(Ytterbium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial LutetiumOxide = new SimpleDustMaterial("lutetium_oxide", Lutetium.materialRGB, (short) 21, Lutetium.materialIconSet, of(new MaterialStack(Lutetium, 1), new MaterialStack(Oxygen, 2)));
    public static final SimpleDustMaterial ScandiumOxide = new SimpleDustMaterial("scandium_oxide", Scandium.materialRGB, (short) 22, Scandium.materialIconSet, of(new MaterialStack(Scandium, 1), new MaterialStack(Oxygen, 2)));
    ...
    public static final IngotMaterial QCDMatter = new IngotMaterial(673, "qcd_confined_matter", 0xeb9e3f, MaterialIconSet.SHINY, 7, of(), GENERATE_PLATE | DISABLE_REPLICATION | NO_WORKING | NO_SMELTING | NO_SMASHING | GENERATE_FRAME, null, 35000);
