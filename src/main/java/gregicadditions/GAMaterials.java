...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleDustMaterial SodiumMetavanadate = new SimpleDustMaterial("manganese_fluoride",SodaAsh.materialRGB,(short) 262, MaterialIconSet.DULL);
    public static final SimpleDustMaterial SodiumHexavanadate = new SimpleDustMaterial("manganese_fluoride",VanadiumMagnetite.materialRGB,(short) 369, MaterialIconSet.DULL);
