...
//    public static Material Plutonium241Isotope;
    ...
    //todo move to ceu
    public static Material FishOil = new Material(999, "fish_oil", 14467421, MaterialIconSet.FLUID, ImmutableList.of(new MaterialStack(RareEarth, 1)), GENERATE_FLUID_BLOCK | DISABLE_DECOMPOSITION);
