...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleFluidMaterial NaquadricSolution = new SimpleFluidMaterial("naquadric_solution", 0x232225, of());
    ...
    public static final SimpleFluidMaterial FluoronaquadriaticAcid = new SimpleFluidMaterial("fluoronaquadriatic_acid", 0x485d60, of(new MaterialStack(Naquadria, 1), new MaterialStack(Hydrogen, 1), new MaterialStack(Fluorine, 6)));
    ...
    public static final SimpleFluidMaterial B27Supplement = new SimpleFluidMaterial("b27_supplement", 0x386939); // C142 H230 N36 O44 S maybe?
    ...
    public static final SimpleDustMaterial Stibene = new SimpleDustMaterial("stibene",0x3c9c3c,(short) 333,MaterialIconSet.DULL); // TODO
    ...
    public static final SimpleDustMaterial PalladiumLoadedRutileNanoparticles = new SimpleDustMaterial("palladium_loaded_rutile_nanoparticles",0xfcfcfa,(short) 345,MaterialIconSet.DULL); // TODO
    ...
    public static final SimpleDustMaterial TlTmCesiumIodide = new SimpleDustMaterial("tl_tm_cesium_iodide",CesiumBromide.rgb*9/10+Thallium.materialRGB/10,(short) 353,MaterialIconSet.DULL); // TODO
    ...
    public static final SimpleDustMaterial PolycyclicAromaticMix = new SimpleDustMaterial("polycyclic_aromatic_mix",Tetracene.rgb,(short) 355,MaterialIconSet.DULL); // TODO
    ...
    public static final SimpleDustMaterial SelectivelyMutatedCupravidiusNecator = new SimpleDustMaterial("selectively_mutated_cupravidius_necator", CupriavidusNecator.rgb * 5 / 4, (short) 373, MaterialIconSet.DULL); // TODO
    ...
    public static final SimpleDustMaterial CoAcABCatalyst = new SimpleDustMaterial("coacab_catalyst", 0x755f30, (short) 900, MaterialIconSet.DULL); // TODO
