...
import static gregtech.api.unification.material.type.FMaterial.MatFlags.GENERATE_LENSE;
...
public class GAMaterials implements IMaterialHandler {
    ...
    public void onMaterialsInit() {
        ...
        Neutronium.setCableProperties(GAValues.V[GAValues.UMV], 2, 32);
        ...
        Caliche.addOreByProducts(Niter,Saltpeter,Lepidolte);
