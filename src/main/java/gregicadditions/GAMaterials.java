...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleDustMaterial SodiumHexavanadate = new SimpleDustMaterial("sodium_hexavanadate",VanadiumMagnetite.materialRGB,(short) 369, MaterialIconSet.DULL);
