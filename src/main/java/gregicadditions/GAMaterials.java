...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final SimpleFluidMaterial SodiumCarbonateSolution = new SimpleFluidMaterial("sodium_carbonate_solution", 0xfcfcfa, "Na2CO3(H2O)");
    public static final SimpleFluidMaterial SodiumSulfateSolution = new SimpleFluidMaterial("sodium_sulfate_solution", 0xfcfcfa, "Na2SO4(H2O) ");
    ...
    public static final SimpleFluidMaterial LithiumCarbonateSolution = new SimpleFluidMaterial("lithium_carbonate_solution", 0xfcfcfa, "Li2CO3(H2O)");
    public static final SimpleFluidMaterial LithiumChlorideSolution = new SimpleFluidMaterial("lithium_chloride_solution", 0xfcfcfa, "LiCl(H2O)");
    ...
    public static final SimpleFluidMaterial ZincExhaustMixture = new SimpleFluidMaterial("zinc_exhaust_mixture", 0xfcfcfa, "(SO2)(CO2)?");
    public static final SimpleFluidMaterial ZincSlagSlurry = new SimpleFluidMaterial("zinc_slag_slurry", 0xfcfcfa, "H2O?");
    ...
    public static final SimpleFluidMaterial LithiumHydroxideSolution = new SimpleFluidMaterial("lithium_hydroxide_solution", 0xfcfcfa, "(H2O)LiOH");
    public static final SimpleFluidMaterial LithiumPeroxideSolution = new SimpleFluidMaterial("lithium_peroxide", 0xfcfcfa, "(H2O)Li2O2");
    ...
    public static final SimpleFluidMaterial SodiumChlorideSolution = new SimpleFluidMaterial("sodium_chloride_solution", 0xfcfcfa, "(H2O)NaCl");
    public static final SimpleFluidMaterial ButhylLithium = new SimpleFluidMaterial("butyl_lithium", 0xfcfcfa, "C4H9Li");
    ...
    public static final SimpleFluidMaterial PureAluminiumHydroxideSolution = new SimpleFluidMaterial("pure_aloh3_soution", 0xfcfcfa, "(H2O)Al(OH)3");
    ...
    public static final SimpleDustMaterial AcrylicFibers = new SimpleDustMaterial("acrylic_fibers", 0xfcfcfa, (short) 135, MaterialIconSet.FINE, "(C5O2H8)n");
    ...
    public static final SimpleDustMaterial NiobiumTantalumOxide = new SimpleDustMaterial("niobium_tantalum_oxide", 0xfcfcfa, (short) 179, MaterialIconSet.SHINY, of(new MaterialStack(Niobium, 2), new MaterialStack(Oxygen, 5), new MaterialStack(Tantalum, 2), new MaterialStack(Oxygen, 5)));
    ...
    public static final SimpleDustMaterial BariumPeroxide = new SimpleDustMaterial("barium_peroxide", 0xfcfcfa, (short) 190, MaterialIconSet.DULL, of(new MaterialStack(Barium, 1), new MaterialStack(Oxygen, 2)));
    ...
    public static final SimpleDustMaterial BariumNitrate = new SimpleDustMaterial("barium_nitrate", 0xfcfcfa, (short) 207, MaterialIconSet.SHINY, of(new MaterialStack(Barium, 1), new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 6)));
    ...
    public static final SimpleDustMaterial BariumChloride = new SimpleDustMaterial("barium_chloride", 0xfcfcfa, (short) 247, MaterialIconSet.DULL, of(new MaterialStack(Barium, 1), new MaterialStack(Chlorine, 2)));
    public static final SimpleDustMaterial TantalumOxide = new SimpleDustMaterial("tantalum_oxide", 0xfcfcfa, (short) 248, MaterialIconSet.SHINY, of(new MaterialStack(Tantalum, 2), new MaterialStack(Oxygen, 5)));
    ...
    public static final SimpleDustMaterial LeadSenenide = new SimpleDustMaterial("lead_selenide", 0xfcfcfa, (short) 250, MaterialIconSet.DULL, of(new MaterialStack(Lead, 1), new MaterialStack(Selenium, 1)));
    public static final SimpleDustMaterial LeadScandiumTantalate = new SimpleDustMaterial("lead_scandium_tantalate", 0xfcfcfa, (short) 251, MaterialIconSet.SHINY, of(new MaterialStack(Lead, 1), new MaterialStack(Scandium, 2), new MaterialStack(Tantalum, 1), new MaterialStack(Oxygen, 3)));
    ...
    public static final SimpleDustMaterial BoronOxide = new SimpleDustMaterial("boron_oxide",0xfcfcfa,(short) 256,MaterialIconSet.DULL, of(new MaterialStack(Boron, 2), new MaterialStack(Oxygen, 3)));
    public static final SimpleDustMaterial LithiumAluminiumFluoride = new SimpleDustMaterial("lithium_aluminium_fluoride",0xfcfcfa,(short) 263,MaterialIconSet.DULL, "AlF4Li");
    ...
    public static final SimpleDustMaterial LithiumIodide = new SimpleDustMaterial("lithium_iodide",0xfcfcfa,(short) 344,MaterialIconSet.DULL, of(new MaterialStack(Lithium, 1), new MaterialStack(Iodine, 1)));
    public static final SimpleDustMaterial PalladiumLoadedRutileNanoparticles = new SimpleDustMaterial("palladium_loaded_rutile_nanoparticles",0xfcfcfa,(short) 345,MaterialIconSet.DULL, "PdTiO2");
