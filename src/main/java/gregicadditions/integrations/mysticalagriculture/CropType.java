...
public final class CropType {
    ...
    public static void init() {
        ...
        SEEDS.put(Polyethylene, new ItemTierSeed(CROPS.get(Polyethylene), Polyethylene, 3));
        SEEDS.put(Epoxy, new ItemTierSeed(CROPS.get(Epoxy), Epoxy, 4));
        SEEDS.put(SiliconeRubber, new ItemTierSeed(CROPS.get(SiliconeRubber), SiliconeRubber, 3));
        ...
        SEEDS.put(PhosphorusPentoxide, new ItemTierSeed(CROPS.get(PhosphorusPentoxide), PhosphorusPentoxide, 2));
        ...
        SEEDS.put(TricalciumPhosphate, new ItemTierSeed(CROPS.get(TricalciumPhosphate), TricalciumPhosphate, 2));
