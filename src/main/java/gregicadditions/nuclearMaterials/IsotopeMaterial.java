...
public class IsotopeMaterial extends EnrichmentProcess { // todo nuclear rework
//
...
//        this.material = from;
////        this.material.addFlag(GENERATE_LONG_ROD, GENERATE_ISOTOPES_COMPOUND, GENERATE_NUCLEAR_COMPOUND); // disable replication todo nuclear rework
