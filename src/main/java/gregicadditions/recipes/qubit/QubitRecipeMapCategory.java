...
public class QubitRecipeMapCategory implements IRecipeCategory<GTQubitRecipeWrapper> {
    ...
    public QubitRecipeMapCategory(QubitRecipeMap recipeMap, IGuiHelper guiHelper) {
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, GTQubitRecipeWrapper recipeWrapper, IIngredients ingredients) {
