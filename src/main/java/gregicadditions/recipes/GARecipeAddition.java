...
//        COMPRESSOR_RECIPES.recipeBuilder().input(dust, Fireclay).outputs(GAMetaItems.COMPRESSED_FIRECLAY.getStackForm()).duration(100).EUt(2).buildAndRegister();
        ...
        if (GAConfig.GT6.BendingCylinders) {
            ...
            ModHandler.addShapedRecipe("bucket", new ItemStack(Items.BUCKET), "ChC", " P ", 'C', plateB + "Iron", 'P', "plateIron");
            ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(4).input(valueOf(plateB), Iron, 2).input(plate, Iron).outputs(new ItemStack(Items.BUCKET)).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(4).input(valueOf(plateB), WroughtIron, 2).input(plate, WroughtIron).outputs(new ItemStack(Items.BUCKET)).buildAndRegister();
            ModHandler.removeRecipeByName(new ResourceLocation("minecraft:iron_helmet"));
            ModHandler.addShapedRecipe("iron_helmet", new ItemStack(Items.IRON_HELMET), "PPP", "ChC", 'P', "plateIron", 'C', plateB + "Iron");
            ModHandler.removeRecipeByName(new ResourceLocation("minecraft:iron_chestplate"));
            ModHandler.addShapedRecipe("iron_chestplate", new ItemStack(Items.IRON_CHESTPLATE), "PhP", "CPC", "CPC", 'P', "plateIron", 'C', plateB + "Iron");
            ModHandler.removeRecipeByName(new ResourceLocation("minecraft:iron_leggings"));
            ModHandler.addShapedRecipe("iron_leggings", new ItemStack(Items.IRON_LEGGINGS), "PCP", "ChC", "C C", 'P', "plateIron", 'C', plateB + "Iron");
            ModHandler.removeRecipeByName(new ResourceLocation("minecraft:iron_boots"));
            ModHandler.addShapedRecipe("iron_boots", new ItemStack(Items.IRON_BOOTS), "P P", "ChC", 'P', "plateIron", 'C', plateB + "Iron");
            ModHandler.removeRecipeByName(new ResourceLocation("minecraft:golden_helmet"));
            ModHandler.addShapedRecipe("golden_helmet", new ItemStack(Items.GOLDEN_HELMET), "PPP", "ChC", 'P', "plateGold", 'C', plateB + "Gold");
            ModHandler.removeRecipeByName(new ResourceLocation("minecraft:golden_chestplate"));
            ModHandler.addShapedRecipe("golden_chestplate", new ItemStack(Items.GOLDEN_CHESTPLATE), "PhP", "CPC", "CPC", 'P', "plateGold", 'C', plateB + "Gold");
            ModHandler.removeRecipeByName(new ResourceLocation("minecraft:golden_leggings"));
            ModHandler.addShapedRecipe("golden_leggings", new ItemStack(Items.GOLDEN_LEGGINGS), "PCP", "ChC", "C C", 'P', "plateGold", 'C', plateB + "Gold");
            ModHandler.removeRecipeByName(new ResourceLocation("minecraft:golden_boots"));
            ModHandler.addShapedRecipe("golden_boots", new ItemStack(Items.GOLDEN_BOOTS), "P P", "ChC", 'P', "plateGold", 'C', plateB + "Gold");
        ...
        if (GAConfig.Misc.assemblerCanMakeComponents) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(OrePrefix.getPrefix("round"), Steel, 8), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(72)).outputs(ELECTRIC_MOTOR_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(cableGtSingle, Copper), CountableIngredient.from(OrePrefix.getPrefix("round"), Aluminium, 8), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(144)).outputs(ELECTRIC_MOTOR_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(cableGtSingle, Gold), CountableIngredient.from(OrePrefix.getPrefix("round"), StainlessSteel, 8), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(288)).outputs(ELECTRIC_MOTOR_HV.getStackForm()).buildAndRegister();
            ...
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(OrePrefix.getPrefix(plateB), Steel, 2), CountableIngredient.from(stickLong, Steel), CountableIngredient.from(gearSmall, Steel), CountableIngredient.from(ELECTRIC_MOTOR_LV.getStackForm())).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PISTON_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(cableGtSingle, Copper), CountableIngredient.from(OrePrefix.getPrefix(plateB), Aluminium, 2), CountableIngredient.from(stickLong, Aluminium), CountableIngredient.from(gearSmall, Aluminium), CountableIngredient.from(ELECTRIC_MOTOR_MV.getStackForm())).fluidInputs(SolderingAlloy.getFluid(144)).outputs(ELECTRIC_PISTON_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(cableGtSingle, Gold), CountableIngredient.from(OrePrefix.getPrefix(plateB), StainlessSteel, 2), CountableIngredient.from(stickLong, StainlessSteel), CountableIngredient.from(gearSmall, StainlessSteel), CountableIngredient.from(ELECTRIC_MOTOR_HV.getStackForm())).fluidInputs(SolderingAlloy.getFluid(288)).outputs(ELECTRIC_PISTON_HV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(cableGtSingle, Aluminium), CountableIngredient.from(OrePrefix.getPrefix(plateB), Titanium, 2), CountableIngredient.from(stickLong, Titanium), CountableIngredient.from(gearSmall, Titanium), CountableIngredient.from(ELECTRIC_MOTOR_EV.getStackForm())).fluidInputs(SolderingAlloy.getFluid(576)).outputs(ELECTRIC_PISTON_EV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(cableGtSingle, Tungsten), CountableIngredient.from(OrePrefix.getPrefix(plateB), TungstenSteel, 2), CountableIngredient.from(stickLong, TungstenSteel), CountableIngredient.from(gearSmall, TungstenSteel), CountableIngredient.from(ELECTRIC_MOTOR_IV.getStackForm())).fluidInputs(SolderingAlloy.getFluid(1152)).outputs(ELECTRIC_PISTON_IV.getStackForm()).buildAndRegister();
            ...
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(circuit, Tier.Basic, 2), CountableIngredient.from(dust, EnderPearl)).fluidInputs(Osmium.getFluid(72)).outputs(FIELD_GENERATOR_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(circuit, Tier.Good, 2), CountableIngredient.from(dust, EnderEye)).fluidInputs(Osmium.getFluid(144)).outputs(FIELD_GENERATOR_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(circuit, Tier.Advanced, 2), CountableIngredient.from(QUANTUM_EYE.getStackForm())).fluidInputs(Osmium.getFluid(288)).outputs(FIELD_GENERATOR_HV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(circuit, Tier.Extreme, 2), CountableIngredient.from(dust, NetherStar)).fluidInputs(Osmium.getFluid(576)).outputs(FIELD_GENERATOR_EV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(CountableIngredient.from(circuit, Tier.Elite, 2), CountableIngredient.from(QUANTUM_STAR.getStackForm())).fluidInputs(Osmium.getFluid(1152)).outputs(FIELD_GENERATOR_IV.getStackForm()).buildAndRegister();

            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(OreDictUnifier.get(cableGtSingle, Tin), ELECTRIC_MOTOR_LV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(OreDictUnifier.get(cableGtSingle, Copper), ELECTRIC_MOTOR_MV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(OreDictUnifier.get(cableGtSingle, Gold), ELECTRIC_MOTOR_HV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_HV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), ELECTRIC_MOTOR_EV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_EV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), ELECTRIC_MOTOR_IV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_IV.getStackForm()).buildAndRegister();

            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Basic).inputs(OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(foil, Steel, 8), OreDictUnifier.get(gem, Quartzite)).fluidInputs(Brass.getFluid(72)).outputs(SENSOR_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Good).inputs(OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(foil, Aluminium, 8), OreDictUnifier.get(gem, NetherQuartz)).fluidInputs(Electrum.getFluid(72)).outputs(SENSOR_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Advanced).inputs(OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(foil, StainlessSteel, 8), OreDictUnifier.get(gem, Emerald)).fluidInputs(Chrome.getFluid(72)).outputs(SENSOR_HV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Extreme).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(foil, Titanium, 8), OreDictUnifier.get(dust, EnderPearl)).fluidInputs(Platinum.getFluid(72)).outputs(SENSOR_EV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Elite).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(foil, TungstenSteel, 8), OreDictUnifier.get(dust, EnderEye)).fluidInputs(Osmium.getFluid(72)).outputs(SENSOR_IV.getStackForm()).buildAndRegister();

            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Basic).inputs(OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(gemFlawless, Quartzite)).fluidInputs(Brass.getFluid(144)).outputs(EMITTER_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Good).inputs(OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(gemFlawless, NetherQuartz)).fluidInputs(Electrum.getFluid(144)).outputs(EMITTER_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Advanced).inputs(OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(gemFlawless, Emerald)).fluidInputs(Chrome.getFluid(144)).outputs(EMITTER_HV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Extreme).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(gem, EnderPearl)).fluidInputs(Platinum.getFluid(144)).outputs(EMITTER_EV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).input(circuit, Tier.Elite).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(gem, EnderEye)).fluidInputs(Osmium.getFluid(144)).outputs(EMITTER_IV.getStackForm()).buildAndRegister();

            for (MaterialStack stackFluid : cableFluids) {
                IngotMaterial m = (IngotMaterial) stackFluid.material;
                ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(ELECTRIC_MOTOR_LV.getStackForm(), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(pipeMedium, Bronze), OreDictUnifier.get(screw, Tin)).inputs(CountableIngredient.from(rotor, Tin), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_LV.getStackForm()).buildAndRegister();
                ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(ELECTRIC_MOTOR_MV.getStackForm(), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(pipeMedium, Steel), OreDictUnifier.get(screw, Bronze)).inputs(CountableIngredient.from(rotor, Bronze), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_MV.getStackForm()).buildAndRegister();
                ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(ELECTRIC_MOTOR_HV.getStackForm(), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(pipeMedium, StainlessSteel), OreDictUnifier.get(screw, Steel)).inputs(CountableIngredient.from(rotor, Steel), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_HV.getStackForm()).buildAndRegister();
                ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(ELECTRIC_MOTOR_EV.getStackForm(), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(pipeMedium, Titanium), OreDictUnifier.get(screw, StainlessSteel)).inputs(CountableIngredient.from(rotor, StainlessSteel), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_EV.getStackForm()).buildAndRegister();
                ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(60).inputs(ELECTRIC_MOTOR_IV.getStackForm(), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(pipeMedium, TungstenSteel), OreDictUnifier.get(screw, TungstenSteel)).inputs(CountableIngredient.from(rotor, TungstenSteel), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_IV.getStackForm()).buildAndRegister();
            }
        }
        ...
        if (GAConfig.Misc.assemblyLineMakeCheaperComponents) {
            ...
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(8000).inputs(CountableIngredient.from(cableGtSingle, Tin, 8), CountableIngredient.from(OrePrefix.getPrefix(plateB), Steel, 2), CountableIngredient.from(plate, Steel, 2), CountableIngredient.from(ingot, Steel, 2), CountableIngredient.from(stickLong, Steel, 2), CountableIngredient.from(stickLong, Steel, 2), CountableIngredient.from(gearSmall, Steel, 4), CountableIngredient.from(gearSmall, Steel, 4), CountableIngredient.from(gearSmall, Steel, 4), CountableIngredient.from(ELECTRIC_MOTOR_LV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(72 * 4)).outputs(ELECTRIC_PISTON_LV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(16000).inputs(CountableIngredient.from(cableGtSingle, Copper, 8), CountableIngredient.from(OrePrefix.getPrefix(plateB), Aluminium, 2), CountableIngredient.from(plate, Aluminium, 2), CountableIngredient.from(ingot, Aluminium, 2), CountableIngredient.from(stickLong, Aluminium, 2), CountableIngredient.from(stickLong, Aluminium, 2), CountableIngredient.from(gearSmall, Aluminium, 4), CountableIngredient.from(gearSmall, Aluminium, 4), CountableIngredient.from(gearSmall, Aluminium, 4), CountableIngredient.from(ELECTRIC_MOTOR_MV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(144 * 4)).outputs(ELECTRIC_PISTON_MV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(32000).inputs(CountableIngredient.from(cableGtSingle, Gold, 8), CountableIngredient.from(OrePrefix.getPrefix(plateB), StainlessSteel, 2), CountableIngredient.from(plate, StainlessSteel, 2), CountableIngredient.from(ingot, StainlessSteel, 2), CountableIngredient.from(stickLong, StainlessSteel, 2), CountableIngredient.from(stickLong, StainlessSteel, 2), CountableIngredient.from(gearSmall, StainlessSteel, 4), CountableIngredient.from(gearSmall, StainlessSteel, 4), CountableIngredient.from(gearSmall, StainlessSteel, 4), CountableIngredient.from(ELECTRIC_MOTOR_HV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(288 * 4)).outputs(ELECTRIC_PISTON_HV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(64000).inputs(CountableIngredient.from(cableGtSingle, Aluminium, 8), CountableIngredient.from(OrePrefix.getPrefix(plateB), Titanium, 2), CountableIngredient.from(plate, Titanium, 2), CountableIngredient.from(ingot, Titanium, 2), CountableIngredient.from(stickLong, Titanium, 2), CountableIngredient.from(stickLong, Titanium, 2), CountableIngredient.from(gearSmall, Titanium, 4), CountableIngredient.from(gearSmall, Titanium, 4), CountableIngredient.from(gearSmall, Titanium, 4), CountableIngredient.from(gearSmall, Titanium, 4), CountableIngredient.from(ELECTRIC_MOTOR_EV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(576 * 4)).outputs(ELECTRIC_PISTON_EV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(128000).inputs(CountableIngredient.from(cableGtSingle, Tungsten, 8), CountableIngredient.from(OrePrefix.getPrefix(plateB), TungstenSteel, 2), CountableIngredient.from(plate, TungstenSteel, 2), CountableIngredient.from(ingot, TungstenSteel, 2), CountableIngredient.from(stickLong, TungstenSteel, 2), CountableIngredient.from(stickLong, TungstenSteel, 2), CountableIngredient.from(gearSmall, TungstenSteel, 4), CountableIngredient.from(gearSmall, TungstenSteel, 4), CountableIngredient.from(gearSmall, TungstenSteel, 4), CountableIngredient.from(gearSmall, TungstenSteel, 4), CountableIngredient.from(ELECTRIC_MOTOR_IV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(1152 * 4)).outputs(ELECTRIC_PISTON_IV.getStackForm(16)).buildAndRegister();
    ...
    public static void init2() {
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(600).EUt(10240).outputs(ELECTRIC_MOTOR_LUV.getStackForm()).inputs(OreDictUnifier.get(stickLong, NeodymiumMagnetic, 1), OreDictUnifier.get(stickLong, HSSG, 2), OreDictUnifier.get(ring, HSSG, 4), OreDictUnifier.get(roundOrScrew, HSSG, 16), OreDictUnifier.get(wireFine, AnnealedCopper, 64), OreDictUnifier.get(wireFine, AnnealedCopper, 64), OreDictUnifier.get(wireFine, AnnealedCopper, 64), OreDictUnifier.get(wireFine, AnnealedCopper, 64), OreDictUnifier.get(cableGtSingle, YttriumBariumCuprate, 2)).fluidInputs(SolderingAlloy.getFluid(144), Lubricant.getFluid(250)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(600).EUt(40960).outputs(ELECTRIC_MOTOR_ZPM.getStackForm()).inputs(OreDictUnifier.get(stickLong, NeodymiumMagnetic, 16), OreDictUnifier.get(stickLong, HSSE, 2), OreDictUnifier.get(ring, HSSE, 4), OreDictUnifier.get(roundOrScrew, HSSE, 16), OreDictUnifier.get(wireFine, Platinum, 64), OreDictUnifier.get(wireFine, Platinum, 64), OreDictUnifier.get(wireFine, Platinum, 64), OreDictUnifier.get(wireFine, Platinum, 64), OreDictUnifier.get(cableGtQuadruple, Naquadah, 2)).fluidInputs(SolderingAlloy.getFluid(288), Lubricant.getFluid(750)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(600).EUt(163840).outputs(ELECTRIC_MOTOR_UV.getStackForm()).inputs(OreDictUnifier.get(stickLong, NeodymiumMagnetic, 64), OreDictUnifier.get(stickLong, Tritanium, 2), OreDictUnifier.get(ring, Tritanium, 4), OreDictUnifier.get(roundOrScrew, Tritanium, 16), OreDictUnifier.get(wireFine, Duranium, 64), OreDictUnifier.get(wireFine, Duranium, 64), OreDictUnifier.get(wireFine, Duranium, 64), OreDictUnifier.get(wireFine, Duranium, 64), OreDictUnifier.get(cableGtQuadruple, Duranium, 2)).fluidInputs(SolderingAlloy.getFluid(1296), Lubricant.getFluid(2000)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(600).EUt(655360).outputs(ELECTRIC_MOTOR_UHV.getStackForm()).inputs(OreDictUnifier.get(stickLong, NeodymiumMagnetic, 64), OreDictUnifier.get(stickLong, NeodymiumMagnetic, 64), OreDictUnifier.get(stickLong, HDCS, 2), OreDictUnifier.get(ring, HDCS, 4), OreDictUnifier.get(roundOrScrew, HDCS, 16), OreDictUnifier.get(wireFine, TungstenTitaniumCarbide, 64), OreDictUnifier.get(wireFine, TungstenTitaniumCarbide, 64), OreDictUnifier.get(wireFine, TungstenTitaniumCarbide, 64), OreDictUnifier.get(wireFine, TungstenTitaniumCarbide, 64)).input(cableGtQuadruple, TungstenTitaniumCarbide, 2).fluidInputs(SolderingAlloy.getFluid(2592), Lubricant.getFluid(3000)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(600).EUt(2621440).outputs(ELECTRIC_MOTOR_UEV.getStackForm()).inputs(OreDictUnifier.get(stickLong, NeodymiumMagnetic, 64), OreDictUnifier.get(stickLong, NeodymiumMagnetic, 64), OreDictUnifier.get(stickLong, HDCS, 2), OreDictUnifier.get(ring, HDCS, 4), OreDictUnifier.get(roundOrScrew, HDCS, 16), OreDictUnifier.get(wireFine, Pikyonium, 64), OreDictUnifier.get(wireFine, Pikyonium, 64), OreDictUnifier.get(wireFine, Pikyonium, 64), OreDictUnifier.get(wireFine, Pikyonium, 64)).input(cableGtQuadruple, Pikyonium, 2).fluidInputs(SolderingAlloy.getFluid(2592), Lubricant.getFluid(3000)).buildAndRegister();
        //pump
        ...
        ModHandler.addShapedRecipe("ga_prospect_tool_zpm", PROSPECT_TOOL_ZPM.getStackForm(), "EDS", "CTC", "PBP", 'E', EMITTER_ZPM.getStackForm(), 'D', new UnificationEntry(toolHeadDrill, HSSS), 'S', SENSOR_ZPM.getStackForm(), 'C', new UnificationEntry(circuit, Tier.Ultimate), 'T', COVER_MACHINE_CONTROLLER.getStackForm(), 'P', new UnificationEntry(plate, HSSS), 'B', GAConfig.GT5U.enableZPMandUVBats ? GAMetaItems.ENERGY_MODULE.getStackForm() : BATTERY_LARGE_LITHIUM_ION.getStackForm());
