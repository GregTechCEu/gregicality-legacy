...
//        COMPRESSOR_RECIPES.recipeBuilder().input(dust, Fireclay).outputs(GAMetaItems.COMPRESSED_FIRECLAY.getStackForm()).duration(100).EUt(2).buildAndRegister();
    ...
    public static void init2() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(320000000).input(wireGtDouble, Neutronium, 8).inputs(MICA_INSULATOR_FOIL.getStackForm(8)).fluidInputs(Neutronium.getFluid(144)).outputs(GAMetaBlocks.HEATING_COIL.getItemVariant(GAHeatingCoil.CoilType.HEATING_COIL_4)).buildAndRegister();
