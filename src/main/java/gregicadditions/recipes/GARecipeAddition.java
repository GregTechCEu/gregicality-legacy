...
public class GARecipeAddition {
    ...
    public static void init() {
        ...
        if (GAConfig.Misc.assemblerCanMakeComponents) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(40).inputs(CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(OrePrefix.getPrefix("round"), Steel, 8), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(72)).outputs(ELECTRIC_MOTOR_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(160).inputs(CountableIngredient.from(cableGtSingle, Copper), CountableIngredient.from(OrePrefix.getPrefix("round"), Aluminium, 8), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(144)).outputs(ELECTRIC_MOTOR_MV.getStackForm()).buildAndRegister();
            ...
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(60).input(circuit, Tier.Basic).inputs(OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(foil, Steel, 8), OreDictUnifier.get(gemFlawless, Quartzite)).fluidInputs(Brass.getFluid(72)).outputs(SENSOR_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(240).input(circuit, Tier.Good).inputs(OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(foil, Aluminium, 8), OreDictUnifier.get(gemFlawless, NetherQuartz)).fluidInputs(Electrum.getFluid(72)).outputs(SENSOR_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(960).input(circuit, Tier.Advanced).inputs(OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(foil, StainlessSteel, 8), OreDictUnifier.get(gemFlawless, Emerald)).fluidInputs(Chrome.getFluid(72)).outputs(SENSOR_HV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(3840).input(circuit, Tier.Extreme).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(foil, Titanium, 8), OreDictUnifier.get(gem, EnderPearl)).fluidInputs(Platinum.getFluid(72)).outputs(SENSOR_EV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(15360).input(circuit, Tier.Elite).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(foil, TungstenSteel, 8), OreDictUnifier.get(gem, EnderEye)).fluidInputs(Osmium.getFluid(72)).outputs(SENSOR_IV.getStackForm()).buildAndRegister();

            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(60).input(circuit, Tier.Basic).inputs(OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(gemFlawless, Quartzite)).fluidInputs(Brass.getFluid(144)).outputs(EMITTER_LV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(240).input(circuit, Tier.Good).inputs(OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(gemFlawless, NetherQuartz)).fluidInputs(Electrum.getFluid(144)).outputs(EMITTER_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(960).input(circuit, Tier.Advanced).inputs(OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(gemFlawless, Emerald)).fluidInputs(Chrome.getFluid(144)).outputs(EMITTER_HV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(3840).input(circuit, Tier.Extreme).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(gem, EnderPearl)).fluidInputs(Platinum.getFluid(144)).outputs(EMITTER_EV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(15360).input(circuit, Tier.Elite).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(gem, EnderEye)).fluidInputs(Osmium.getFluid(144)).outputs(EMITTER_IV.getStackForm()).buildAndRegister();
        ...
        if (GAConfig.Misc.assemblyLineMakeCheaperComponents) {
            ...
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(8000).inputs(CountableIngredient.from(cableGtSingle, Tin, 8), CountableIngredient.from(OrePrefix.getPrefix("plateCurved"), Steel, 2), CountableIngredient.from(plate, Steel, 2), CountableIngredient.from(ingot, Steel, 2), CountableIngredient.from(stickLong, Steel, 2), CountableIngredient.from(stickLong, Steel, 2), CountableIngredient.from(gearSmall, Steel, 4), CountableIngredient.from(gearSmall, Steel, 4), CountableIngredient.from(gearSmall, Steel, 4), CountableIngredient.from(ELECTRIC_MOTOR_LV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(72 * 4)).outputs(ELECTRIC_PISTON_LV.getStackForm(4)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(16000).inputs(CountableIngredient.from(cableGtSingle, Copper, 8), CountableIngredient.from(OrePrefix.getPrefix("plateCurved"), Aluminium, 2), CountableIngredient.from(plate, Aluminium, 2), CountableIngredient.from(ingot, Aluminium, 2), CountableIngredient.from(stickLong, Aluminium, 2), CountableIngredient.from(stickLong, Aluminium, 2), CountableIngredient.from(gearSmall, Aluminium, 4), CountableIngredient.from(gearSmall, Aluminium, 4), CountableIngredient.from(gearSmall, Aluminium, 4), CountableIngredient.from(ELECTRIC_MOTOR_MV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(144 * 4)).outputs(ELECTRIC_PISTON_MV.getStackForm(4)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(32000).inputs(CountableIngredient.from(cableGtSingle, Gold, 8), CountableIngredient.from(OrePrefix.getPrefix("plateCurved"), StainlessSteel, 2), CountableIngredient.from(plate, StainlessSteel, 2), CountableIngredient.from(ingot, StainlessSteel, 2), CountableIngredient.from(stickLong, StainlessSteel, 2), CountableIngredient.from(stickLong, StainlessSteel, 2), CountableIngredient.from(gearSmall, StainlessSteel, 4), CountableIngredient.from(gearSmall, StainlessSteel, 4), CountableIngredient.from(gearSmall, StainlessSteel, 4), CountableIngredient.from(ELECTRIC_MOTOR_HV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(288 * 4)).outputs(ELECTRIC_PISTON_HV.getStackForm(4)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(64000).inputs(CountableIngredient.from(cableGtSingle, Aluminium, 8), CountableIngredient.from(OrePrefix.getPrefix("plateCurved"), Titanium, 2), CountableIngredient.from(plate, Titanium, 2), CountableIngredient.from(ingot, Titanium, 2), CountableIngredient.from(stickLong, Titanium, 2), CountableIngredient.from(stickLong, Titanium, 2), CountableIngredient.from(gearSmall, Titanium, 4), CountableIngredient.from(gearSmall, Titanium, 4), CountableIngredient.from(gearSmall, Titanium, 4), CountableIngredient.from(gearSmall, Titanium, 4), CountableIngredient.from(ELECTRIC_MOTOR_EV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(576 * 4)).outputs(ELECTRIC_PISTON_EV.getStackForm(4)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(128000).inputs(CountableIngredient.from(cableGtSingle, Tungsten, 8), CountableIngredient.from(OrePrefix.getPrefix("plateCurved"), TungstenSteel, 2), CountableIngredient.from(plate, TungstenSteel, 2), CountableIngredient.from(ingot, TungstenSteel, 2), CountableIngredient.from(stickLong, TungstenSteel, 2), CountableIngredient.from(stickLong, TungstenSteel, 2), CountableIngredient.from(gearSmall, TungstenSteel, 4), CountableIngredient.from(gearSmall, TungstenSteel, 4), CountableIngredient.from(gearSmall, TungstenSteel, 4), CountableIngredient.from(gearSmall, TungstenSteel, 4), CountableIngredient.from(ELECTRIC_MOTOR_IV.getStackForm(4))).fluidInputs(SolderingAlloy.getFluid(1152 * 4)).outputs(ELECTRIC_PISTON_IV.getStackForm(4)).buildAndRegister();
    ...
    public static void init2() {
        ...
        if (GAConfig.Misc.tungstenProcess) {
            ...
            CHEMICAL_RECIPES.recipeBuilder()
                    ...
                    .outputs(OreDictUnifier.get(dust, CalciumTungstate))
            ...
            CHEMICAL_RECIPES.recipeBuilder()
                    .input(dust, CalciumTungstate)
                    .fluidInputs(Water.getFluid(2000))
                    .fluidInputs(HydrochloricAcid.getFluid(1000))
                    .outputs(OreDictUnifier.get(dust, TungsticAcid))
