...
//        COMPRESSOR_RECIPES.recipeBuilder().input(dust, Fireclay).outputs(GAMetaItems.COMPRESSED_FIRECLAY.getStackForm()).duration(100).EUt(2).buildAndRegister();
    ...
    public static void init2() {
        ...
        ADV_FUSION_RECIPES.recipeBuilder().fluidInputs(Trinium.getFluid(125), Tritanium.getFluid(125)).fluidOutputs(Adamantium.getFluid(125)).duration(100).EUt(2000000).coilTier(1).euStart(1000000000).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(320000000).inputs(OreDictUnifier.get(wireGtDouble, Neutronium, 8), MICA_INSULATOR_FOIL.getStackForm(8)).fluidInputs(Neutronium.getFluid(144)).outputs(GAMetaBlocks.HEATING_COIL.getItemVariant(GAHeatingCoil.CoilType.HEATING_COIL_4)).buildAndRegister();
