...
public class GARecipeAddition {
    ...
    public static void init() {
        ...
        removeRecipesByInputs(ASSEMBLER_RECIPES, new ItemStack[]{OreDictUnifier.get(circuit, Tier.Basic, 4), OreDictUnifier.get(dust, EnderPearl)}, new FluidStack[]{Osmium.getFluid(288)});
        removeRecipesByInputs(ASSEMBLER_RECIPES, new ItemStack[]{OreDictUnifier.get(circuit, Tier.Good, 4), OreDictUnifier.get(dust, EnderPearl)}, new FluidStack[]{Osmium.getFluid(576)});
        removeRecipesByInputs(ASSEMBLER_RECIPES, new ItemStack[]{OreDictUnifier.get(circuit, Tier.Advanced, 4), QUANTUM_EYE.getStackForm()}, new FluidStack[]{Osmium.getFluid(1152)});
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(120).inputs(CountableIngredient.from(circuit, Tier.Basic, 2), CountableIngredient.from(dust, EnderPearl)).fluidInputs(Osmium.getFluid(72)).outputs(FIELD_GENERATOR_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(480).inputs(CountableIngredient.from(circuit, Tier.Good, 2), CountableIngredient.from(dust, EnderEye)).fluidInputs(Osmium.getFluid(144)).outputs(FIELD_GENERATOR_MV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(1920).inputs(CountableIngredient.from(circuit, Tier.Advanced, 2), CountableIngredient.from(QUANTUM_EYE.getStackForm())).fluidInputs(Osmium.getFluid(244)).outputs(FIELD_GENERATOR_HV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(7680).inputs(CountableIngredient.from(circuit, Tier.Extreme, 2), CountableIngredient.from(dust, NetherStar)).fluidInputs(Osmium.getFluid(576)).outputs(FIELD_GENERATOR_EV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(30720).inputs(CountableIngredient.from(circuit, Tier.Elite, 2), CountableIngredient.from(QUANTUM_STAR.getStackForm())).fluidInputs(Osmium.getFluid(1152)).outputs(FIELD_GENERATOR_IV.getStackForm()).buildAndRegister();

        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(40).inputs(CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(stick, Iron), CountableIngredient.from(stick, IronMagnetic)).fluidInputs(Copper.getFluid(72)).outputs(ELECTRIC_MOTOR_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(40).inputs(CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(stick, Steel), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(72)).outputs(ELECTRIC_MOTOR_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(160).inputs(CountableIngredient.from(cableGtSingle, Copper), CountableIngredient.from(stick, Aluminium), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(144)).outputs(ELECTRIC_MOTOR_MV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(640).inputs(CountableIngredient.from(cableGtSingle, Gold), CountableIngredient.from(stick, StainlessSteel), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(288)).outputs(ELECTRIC_MOTOR_HV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(2560).inputs(CountableIngredient.from(cableGtSingle, Aluminium), CountableIngredient.from(stick, Titanium), CountableIngredient.from(stick, NeodymiumMagnetic)).fluidInputs(AnnealedCopper.getFluid(576)).outputs(ELECTRIC_MOTOR_EV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(10240).inputs(CountableIngredient.from(cableGtSingle, Tungsten), CountableIngredient.from(stick, TungstenSteel), CountableIngredient.from(stick, NeodymiumMagnetic)).fluidInputs(AnnealedCopper.getFluid(1152)).outputs(ELECTRIC_MOTOR_IV.getStackForm()).buildAndRegister();

        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(60).inputs(OreDictUnifier.get(cableGtSingle, Tin), ELECTRIC_MOTOR_LV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(240).inputs(OreDictUnifier.get(cableGtSingle, Copper), ELECTRIC_MOTOR_MV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_MV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(960).inputs(OreDictUnifier.get(cableGtSingle, Gold), ELECTRIC_MOTOR_HV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_HV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(3840).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), ELECTRIC_MOTOR_EV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_EV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(15360).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), ELECTRIC_MOTOR_IV.getStackForm(1)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_IV.getStackForm()).buildAndRegister();

        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(60).input(circuit, Tier.Basic).inputs(OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(gem, Quartzite)).fluidInputs(Brass.getFluid(72)).outputs(EMITTER_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(240).input(circuit, Tier.Good).inputs(OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(gem, NetherQuartz)).fluidInputs(Electrum.getFluid(72)).outputs(EMITTER_MV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(960).input(circuit, Tier.Advanced).inputs(OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(gem, Emerald)).fluidInputs(Chrome.getFluid(72)).outputs(EMITTER_HV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(3840).input(circuit, Tier.Extreme).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(gem, EnderPearl)).fluidInputs(Platinum.getFluid(72)).outputs(EMITTER_EV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(15360).input(circuit, Tier.Elite).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(gem, EnderEye)).fluidInputs(Osmium.getFluid(72)).outputs(EMITTER_IV.getStackForm()).buildAndRegister();

        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(40).inputs(ELECTRIC_MOTOR_LV.getStackForm(), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(pipeMedium, Bronze), OreDictUnifier.get(screw, Tin)).inputs(CountableIngredient.from(rotor, Tin), CountableIngredient.from(ring, Paper, 2)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_LV.getStackForm()).buildAndRegister();
        for (MaterialStack stackFluid : cableFluids) {
            IngotMaterial m = (IngotMaterial) stackFluid.material;
            ...
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(160).inputs(ELECTRIC_MOTOR_MV.getStackForm(), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(pipeMedium, Steel), OreDictUnifier.get(screw, Bronze)).inputs(CountableIngredient.from(rotor, Bronze), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_MV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(640).inputs(ELECTRIC_MOTOR_HV.getStackForm(), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(pipeMedium, StainlessSteel), OreDictUnifier.get(screw, Steel)).inputs(CountableIngredient.from(rotor, Steel), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_HV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(2560).inputs(ELECTRIC_MOTOR_EV.getStackForm(), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(pipeMedium, Titanium), OreDictUnifier.get(screw, StainlessSteel)).inputs(CountableIngredient.from(rotor, StainlessSteel), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_EV.getStackForm()).buildAndRegister();
            ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(10240).inputs(ELECTRIC_MOTOR_IV.getStackForm(), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(pipeMedium, TungstenSteel), OreDictUnifier.get(screw, TungstenSteel)).inputs(CountableIngredient.from(rotor, TungstenSteel), CountableIngredient.from(ring, m)).fluidInputs(SolderingAlloy.getFluid(72)).outputs(ELECTRIC_PUMP_IV.getStackForm()).buildAndRegister();
        }

        //Automatic Machine Component Recipes with assembly line

        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(circuit, Tier.Basic, 2), CountableIngredient.from(circuit, Tier.Basic, 2), CountableIngredient.from(circuit, Tier.Basic, 2), CountableIngredient.from(circuit, Tier.Basic, 2), CountableIngredient.from(dust, EnderPearl), CountableIngredient.from(dust, EnderPearl), CountableIngredient.from(dust, EnderPearl), CountableIngredient.from(dust, EnderPearl)).fluidInputs(Osmium.getFluid(72 * 4)).outputs(FIELD_GENERATOR_LV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(circuit, Tier.Good, 2), CountableIngredient.from(circuit, Tier.Good, 2), CountableIngredient.from(circuit, Tier.Good, 2), CountableIngredient.from(circuit, Tier.Good, 2), CountableIngredient.from(dust, EnderEye), CountableIngredient.from(dust, EnderEye), CountableIngredient.from(dust, EnderEye), CountableIngredient.from(dust, EnderEye)).fluidInputs(Osmium.getFluid(144 * 4)).outputs(FIELD_GENERATOR_MV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(circuit, Tier.Advanced, 2), CountableIngredient.from(circuit, Tier.Advanced, 2), CountableIngredient.from(circuit, Tier.Advanced, 2), CountableIngredient.from(circuit, Tier.Advanced, 2), CountableIngredient.from(QUANTUM_EYE.getStackForm()), CountableIngredient.from(QUANTUM_EYE.getStackForm()), CountableIngredient.from(QUANTUM_EYE.getStackForm()), CountableIngredient.from(QUANTUM_EYE.getStackForm())).fluidInputs(Osmium.getFluid(244 * 4)).outputs(FIELD_GENERATOR_HV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(circuit, Tier.Extreme, 2), CountableIngredient.from(circuit, Tier.Extreme, 2), CountableIngredient.from(circuit, Tier.Extreme, 2), CountableIngredient.from(circuit, Tier.Extreme, 2), CountableIngredient.from(dust, NetherStar), CountableIngredient.from(dust, NetherStar), CountableIngredient.from(dust, NetherStar), CountableIngredient.from(dust, NetherStar)).fluidInputs(Osmium.getFluid(576 * 4)).outputs(FIELD_GENERATOR_EV.getStackForm(64)).buildAndRegister();
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(stick, Iron, 4), CountableIngredient.from(stick, IronMagnetic, 4)).fluidInputs(Copper.getFluid(72 * 4)).outputs(ELECTRIC_MOTOR_LV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(cableGtSingle, Tin), CountableIngredient.from(stick, Steel, 4), CountableIngredient.from(stick, SteelMagnetic, 4)).fluidInputs(Copper.getFluid(72 * 4)).outputs(ELECTRIC_MOTOR_LV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(cableGtSingle, Copper), CountableIngredient.from(cableGtSingle, Copper), CountableIngredient.from(cableGtSingle, Copper), CountableIngredient.from(cableGtSingle, Copper), CountableIngredient.from(stick, Aluminium, 4), CountableIngredient.from(stick, SteelMagnetic, 4)).fluidInputs(Copper.getFluid(144 * 4)).outputs(ELECTRIC_MOTOR_MV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(cableGtSingle, Gold), CountableIngredient.from(cableGtSingle, Gold), CountableIngredient.from(cableGtSingle, Gold), CountableIngredient.from(cableGtSingle, Gold), CountableIngredient.from(stick, StainlessSteel, 4), CountableIngredient.from(stick, SteelMagnetic, 4)).fluidInputs(Copper.getFluid(288 * 4)).outputs(ELECTRIC_MOTOR_HV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(cableGtSingle, Aluminium), CountableIngredient.from(cableGtSingle, Aluminium), CountableIngredient.from(cableGtSingle, Aluminium), CountableIngredient.from(cableGtSingle, Aluminium), CountableIngredient.from(stick, Titanium, 4), CountableIngredient.from(stick, NeodymiumMagnetic, 4)).fluidInputs(AnnealedCopper.getFluid(576 * 4)).outputs(ELECTRIC_MOTOR_EV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(CountableIngredient.from(cableGtSingle, Tungsten), CountableIngredient.from(cableGtSingle, Tungsten), CountableIngredient.from(cableGtSingle, Tungsten), CountableIngredient.from(cableGtSingle, Tungsten), CountableIngredient.from(stick, TungstenSteel, 4), CountableIngredient.from(stick, NeodymiumMagnetic, 4)).fluidInputs(AnnealedCopper.getFluid(1152 * 4)).outputs(ELECTRIC_MOTOR_IV.getStackForm(64)).buildAndRegister();

        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), ELECTRIC_MOTOR_LV.getStackForm(4)).fluidInputs(Rubber.getFluid(432 * 4)).outputs(CONVEYOR_MODULE_LV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), ELECTRIC_MOTOR_MV.getStackForm(4)).fluidInputs(Rubber.getFluid(432 * 4)).outputs(CONVEYOR_MODULE_MV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), ELECTRIC_MOTOR_HV.getStackForm(4)).fluidInputs(Rubber.getFluid(432 * 4)).outputs(CONVEYOR_MODULE_HV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), ELECTRIC_MOTOR_EV.getStackForm(4)).fluidInputs(Rubber.getFluid(432 * 4)).outputs(CONVEYOR_MODULE_EV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), ELECTRIC_MOTOR_IV.getStackForm(4)).fluidInputs(Rubber.getFluid(432 * 4)).outputs(CONVEYOR_MODULE_IV.getStackForm(64)).buildAndRegister();

        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).input(circuit, Tier.Basic).inputs(OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(gem, Quartzite, 4)).fluidInputs(Brass.getFluid(72 * 4)).outputs(EMITTER_LV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).input(circuit, Tier.Good).inputs(OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(gem, NetherQuartz, 4)).fluidInputs(Electrum.getFluid(72 * 4)).outputs(EMITTER_MV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).input(circuit, Tier.Advanced).inputs(OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(gem, Emerald, 4)).fluidInputs(Chrome.getFluid(72 * 4)).outputs(EMITTER_HV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).input(circuit, Tier.Extreme).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(gem, EnderPearl, 4)).fluidInputs(Platinum.getFluid(72 * 4)).outputs(EMITTER_EV.getStackForm(64)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).input(circuit, Tier.Elite).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(gem, EnderEye, 4)).fluidInputs(Osmium.getFluid(72 * 4)).outputs(EMITTER_IV.getStackForm(64)).buildAndRegister();

        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(ELECTRIC_MOTOR_LV.getStackForm(4), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(pipeMedium, Bronze), OreDictUnifier.get(screw, Tin, 16)).inputs(CountableIngredient.from(rotor, Tin, 4), CountableIngredient.from(ring, Paper, 8)).fluidInputs(SolderingAlloy.getFluid(72 * 4)).outputs(ELECTRIC_PUMP_LV.getStackForm(64)).buildAndRegister();
        for (MaterialStack stackFluid : cableFluids) {
            IngotMaterial m = (IngotMaterial) stackFluid.material;
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(ELECTRIC_MOTOR_LV.getStackForm(4), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(cableGtSingle, Tin), OreDictUnifier.get(pipeMedium, Bronze), OreDictUnifier.get(screw, Tin, 16)).inputs(CountableIngredient.from(rotor, Tin, 4), CountableIngredient.from(ring, m, 8)).fluidInputs(SolderingAlloy.getFluid(72 * 4)).outputs(ELECTRIC_PUMP_LV.getStackForm(64)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(ELECTRIC_MOTOR_MV.getStackForm(4), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(cableGtSingle, Copper), OreDictUnifier.get(pipeMedium, Steel), OreDictUnifier.get(screw, Bronze, 16)).inputs(CountableIngredient.from(rotor, Bronze, 4), CountableIngredient.from(ring, m, 8)).fluidInputs(SolderingAlloy.getFluid(72 * 4)).outputs(ELECTRIC_PUMP_MV.getStackForm(64)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(ELECTRIC_MOTOR_HV.getStackForm(4), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(cableGtSingle, Gold), OreDictUnifier.get(pipeMedium, StainlessSteel), OreDictUnifier.get(screw, Steel, 16)).inputs(CountableIngredient.from(rotor, Steel, 4), CountableIngredient.from(ring, m, 8)).fluidInputs(SolderingAlloy.getFluid(72 * 4)).outputs(ELECTRIC_PUMP_HV.getStackForm(64)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(ELECTRIC_MOTOR_EV.getStackForm(4), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(cableGtSingle, Aluminium), OreDictUnifier.get(pipeMedium, Titanium), OreDictUnifier.get(screw, StainlessSteel, 16)).inputs(CountableIngredient.from(rotor, StainlessSteel, 4), CountableIngredient.from(ring, m, 8)).fluidInputs(SolderingAlloy.getFluid(72 * 4)).outputs(ELECTRIC_PUMP_EV.getStackForm(64)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(80000).inputs(ELECTRIC_MOTOR_IV.getStackForm(4), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(cableGtSingle, Tungsten), OreDictUnifier.get(pipeMedium, TungstenSteel), OreDictUnifier.get(screw, TungstenSteel, 16)).inputs(CountableIngredient.from(rotor, TungstenSteel, 4), CountableIngredient.from(ring, m, 8)).fluidInputs(SolderingAlloy.getFluid(72 * 4)).outputs(ELECTRIC_PUMP_IV.getStackForm(64)).buildAndRegister();
        }
        ...
        //ASSEMBLY
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(400).EUt(120000).outputs(WETWARE_PROCESSOR_ASSEMBLY_ZPM.getStackForm()).inputs(WETWARE_PROCESSOR_LUV.getStackForm(3), SMD_RESISTOR_CRYSTAL.getStackForm(32), SMD_TRANSISTOR_CRYSTAL.getStackForm(32), SMD_CAPACITOR_CRYSTAL.getStackForm(32), SMD_DIODE_CRYSTAL.getStackForm(32), RANDOM_ACCESS_MEMORY.getStackForm(1), QUANTUM_EYE.getStackForm(4), NEURO_PROCESSOR.getStackForm()).input(wireGtSingle, ZPMSuperconductor, 4).input(foil, SiliconeRubber, 16).fluidInputs(SterileGrowthMedium.getFluid(2000)).buildAndRegister();
        ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(400).EUt(120000).outputs(WETWARE_PROCESSOR_ASSEMBLY_ZPM.getStackForm()).inputs(WETWARE_PROCESSOR_LUV.getStackForm(3), SMD_RESISTOR_WETWARE.getStackForm(16), SMD_TRANSISTOR_WETWARE.getStackForm(16), SMD_CAPACITOR_WETWARE.getStackForm(16), SMD_DIODE_WETWARE.getStackForm(16), RANDOM_ACCESS_MEMORY.getStackForm(1), QUANTUM_EYE.getStackForm(4), NEURO_PROCESSOR.getStackForm()).input(wireGtSingle, ZPMSuperconductor, 4).input(foil, SiliconeRubber, 16).fluidInputs(SterileGrowthMedium.getFluid(2000)).buildAndRegister();
        //COMPUTER
