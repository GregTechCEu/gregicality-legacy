...
public class GARecipeAddition {
    ...
    public static void init() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(8000).input(circuit, Tier.Elite).inputs(OreDictUnifier.get(gear, Nitinol60), OreDictUnifier.get(plate, Nitinol60), TOOL_DATA_ORB.getStackForm(), OreDictUnifier.get(cableGtOctal, Nichrome), MetaTileEntities.HULL[GTValues.IV].getStackForm()).fluidInputs(Thorium.getFluid(1440)).outputs(GAMetaBlocks.MUTLIBLOCK_CASING.getItemVariant(GAMultiblockCasing.CasingType.TIERED_HULL_IV, 1)).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(8000).input(circuit, Tier.Master).inputs(OreDictUnifier.get(gear, IncoloyMA956), OreDictUnifier.get(plate, IncoloyMA956), TOOL_DATA_ORB.getStackForm(), OreDictUnifier.get(cableGtOctal, Platinum), MetaTileEntities.HULL[GTValues.LuV].getStackForm()).fluidInputs(Uranium235.getFluid(1440)).outputs(GAMetaBlocks.MUTLIBLOCK_CASING.getItemVariant(GAMultiblockCasing.CasingType.TIERED_HULL_LUV, 1)).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(8000).input(circuit, Tier.Ultimate).inputs(OreDictUnifier.get(gear, BabbitAlloy), OreDictUnifier.get(plate, BabbitAlloy), TOOL_DATA_ORB.getStackForm(), OreDictUnifier.get(cableGtOctal, NiobiumTitanium), MetaTileEntities.HULL[GTValues.ZPM].getStackForm()).fluidInputs(Plutonium241.getFluid(1440)).outputs(GAMetaBlocks.MUTLIBLOCK_CASING.getItemVariant(GAMultiblockCasing.CasingType.TIERED_HULL_ZPM, 1)).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(100).EUt(8000).input(circuit, Tier.Superconductor).inputs(OreDictUnifier.get(gear, HG1223), OreDictUnifier.get(plate, HG1223), TOOL_DATA_ORB.getStackForm(), OreDictUnifier.get(cableGtOctal, YttriumBariumCuprate), MetaTileEntities.HULL[GTValues.UV].getStackForm()).fluidInputs(NaquadahEnriched.getFluid(1440)).outputs(GAMetaBlocks.MUTLIBLOCK_CASING.getItemVariant(GAMultiblockCasing.CasingType.TIERED_HULL_UV, 1)).buildAndRegister();
        ...
        ModHandler.addShapedRecipe("gautils:coated_board_shaped", COATED_BOARD.getStackForm(3), "RRR", "BBB", "RRR", 'R', RUBBER_DROP, 'B', "plateWood");
        ModHandler.addShapelessRecipe("gautils:coated_board_shapeless", COATED_BOARD.getStackForm(), RUBBER_DROP, RUBBER_DROP, "plateWood");
        ModHandler.addShapedRecipe("gautils:basic_board", BASIC_BOARD.getStackForm(), "WWW", "WBW", "WWW", 'W', new UnificationEntry(wireGtSingle, Copper), 'B', COATED_BOARD);
        ...
        ModHandler.addShapedRecipe("gautils:good_board", GOOD_PHENOLIC_BOARD.getStackForm(), "WWW", "WBW", "WWW", 'W', new UnificationEntry(wireGtSingle, Gold), 'B', PHENOLIC_BOARD);
