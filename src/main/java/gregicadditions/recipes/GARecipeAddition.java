...
public class GARecipeAddition {
    ...
    public static void init() {
        ...
        if (GAConfig.Misc.assemblyLineMakeCheaperComponents) {
            ...
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(8000).inputs(CountableIngredient.from(cableGtSingle, Tin, 4), CountableIngredient.from(cableGtSingle, Tin, 4), CountableIngredient.from(cableGtSingle, Tin, 4), CountableIngredient.from(cableGtSingle, Tin, 4), CountableIngredient.from(stick, Iron, 4), CountableIngredient.from(stick, IronMagnetic, 4)).fluidInputs(Copper.getFluid(72 * 4)).outputs(ELECTRIC_MOTOR_LV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(8000).inputs(CountableIngredient.from(cableGtSingle, Tin, 4), CountableIngredient.from(cableGtSingle, Tin, 4), CountableIngredient.from(cableGtSingle, Tin, 4), CountableIngredient.from(cableGtSingle, Tin, 4), CountableIngredient.from(stick, Steel, 4), CountableIngredient.from(stick, SteelMagnetic, 4)).fluidInputs(Copper.getFluid(72 * 4)).outputs(ELECTRIC_MOTOR_LV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(16000).inputs(CountableIngredient.from(cableGtSingle, Copper, 4), CountableIngredient.from(cableGtSingle, Copper, 4), CountableIngredient.from(cableGtSingle, Copper, 4), CountableIngredient.from(cableGtSingle, Copper, 4), CountableIngredient.from(stick, Aluminium, 4), CountableIngredient.from(stick, SteelMagnetic, 4)).fluidInputs(Copper.getFluid(144 * 4)).outputs(ELECTRIC_MOTOR_MV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(32000).inputs(CountableIngredient.from(cableGtSingle, Gold, 4), CountableIngredient.from(cableGtSingle, Gold, 4), CountableIngredient.from(cableGtSingle, Gold, 4), CountableIngredient.from(cableGtSingle, Gold, 4), CountableIngredient.from(stick, StainlessSteel, 4), CountableIngredient.from(stick, SteelMagnetic, 4)).fluidInputs(Copper.getFluid(288 * 4)).outputs(ELECTRIC_MOTOR_HV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(64000).inputs(CountableIngredient.from(cableGtSingle, Aluminium, 4), CountableIngredient.from(cableGtSingle, Aluminium, 4), CountableIngredient.from(cableGtSingle, Aluminium, 4), CountableIngredient.from(cableGtSingle, Aluminium, 4), CountableIngredient.from(stick, Titanium, 4), CountableIngredient.from(stick, NeodymiumMagnetic, 4)).fluidInputs(AnnealedCopper.getFluid(576 * 4)).outputs(ELECTRIC_MOTOR_EV.getStackForm(16)).buildAndRegister();
            ASSEMBLY_LINE_RECIPES.recipeBuilder().duration(6000).EUt(128000).inputs(CountableIngredient.from(cableGtSingle, Tungsten, 4), CountableIngredient.from(cableGtSingle, Tungsten, 4), CountableIngredient.from(cableGtSingle, Tungsten, 4), CountableIngredient.from(cableGtSingle, Tungsten, 4), CountableIngredient.from(stick, TungstenSteel, 4), CountableIngredient.from(stick, NeodymiumMagnetic, 4)).fluidInputs(AnnealedCopper.getFluid(1152 * 4)).outputs(ELECTRIC_MOTOR_IV.getStackForm(16)).buildAndRegister();
