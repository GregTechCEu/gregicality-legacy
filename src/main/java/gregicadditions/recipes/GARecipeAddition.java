...
/*        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(30).inputs(CountableIngredient.from(circuit, Tier.Basic, 4), CountableIngredient.from(dust, EnderPearl)).fluidInputs(Osmium.getFluid(288)).outputs(FIELD_GENERATOR_LV.getStackForm()).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(10).inputs(CountableIngredient.from(cableGtSingle, Tin, 2), CountableIngredient.from(stick, Iron, 2), CountableIngredient.from(stick, IronMagnetic)).fluidInputs(Copper.getFluid(72)).outputs(ELECTRIC_MOTOR_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(10).inputs(CountableIngredient.from(cableGtSingle, Tin, 2), CountableIngredient.from(stick, Steel, 2), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(72)).outputs(ELECTRIC_MOTOR_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(40).inputs(CountableIngredient.from(cableGtSingle, Copper, 2), CountableIngredient.from(stick, Aluminium, 2), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(144)).outputs(ELECTRIC_MOTOR_MV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(160).inputs(CountableIngredient.from(cableGtSingle, Gold, 2), CountableIngredient.from(stick, StainlessSteel, 2), CountableIngredient.from(stick, SteelMagnetic)).fluidInputs(Copper.getFluid(288)).outputs(ELECTRIC_MOTOR_HV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(640).inputs(CountableIngredient.from(cableGtSingle, Aluminium, 2), CountableIngredient.from(stick, Titanium, 2), CountableIngredient.from(stick, NeodymiumMagnetic)).fluidInputs(AnnealedCopper.getFluid(576)).outputs(ELECTRIC_MOTOR_EV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(2560).inputs(CountableIngredient.from(cableGtSingle, Tungsten, 2), CountableIngredient.from(stick, TungstenSteel, 2), CountableIngredient.from(stick, NeodymiumMagnetic)).fluidInputs(AnnealedCopper.getFluid(1152)).outputs(ELECTRIC_MOTOR_IV.getStackForm()).buildAndRegister();

        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(15).inputs(OreDictUnifier.get(cableGtSingle, Tin), ELECTRIC_MOTOR_LV.getStackForm(2)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(60).inputs(OreDictUnifier.get(cableGtSingle, Copper), ELECTRIC_MOTOR_MV.getStackForm(2)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_MV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(240).inputs(OreDictUnifier.get(cableGtSingle, Gold), ELECTRIC_MOTOR_HV.getStackForm(2)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_HV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(960).inputs(OreDictUnifier.get(cableGtSingle, Aluminium), ELECTRIC_MOTOR_EV.getStackForm(2)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_EV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(3840).inputs(OreDictUnifier.get(cableGtSingle, Tungsten), ELECTRIC_MOTOR_IV.getStackForm(2)).fluidInputs(Rubber.getFluid(432)).outputs(CONVEYOR_MODULE_IV.getStackForm()).buildAndRegister();

        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(15).input(circuit, Tier.Basic, 2).inputs(OreDictUnifier.get(cableGtSingle, Tin, 2), OreDictUnifier.get(gem, Quartzite)).fluidInputs(Brass.getFluid(72)).outputs(EMITTER_LV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(60).input(circuit, Tier.Good, 2).inputs(OreDictUnifier.get(cableGtSingle, Copper, 2), OreDictUnifier.get(gem, NetherQuartz)).fluidInputs(Electrum.getFluid(72)).outputs(EMITTER_MV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(240).input(circuit, Tier.Advanced, 2).inputs(OreDictUnifier.get(cableGtSingle, Gold, 2), OreDictUnifier.get(gem, Emerald)).fluidInputs(Chrome.getFluid(72)).outputs(EMITTER_HV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(960).input(circuit, MarkerMaterials.Tier.Extreme, 2).inputs(OreDictUnifier.get(cableGtSingle, Aluminium, 2), OreDictUnifier.get(gem, EnderPearl)).fluidInputs(Platinum.getFluid(72)).outputs(EMITTER_EV.getStackForm()).buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(3840).input(circuit, Tier.Elite, 2).inputs(OreDictUnifier.get(cableGtSingle, Tungsten, 2), OreDictUnifier.get(gem, EnderEye)).fluidInputs(Osmium.getFluid(72)).outputs(EMITTER_IV.getStackForm()).buildAndRegister();
