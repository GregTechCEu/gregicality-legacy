...
public class GARecipeAddition {
    ...
    public static void init() {
        ...
        MIXER_RECIPES.recipeBuilder().duration(50).EUt(120)
                ...
                .outputs(OreDictUnifier.get(dust, BabbitAlloy, 50)).buildAndRegister();
