...
public class MachineCraftingRecipes {
	...
	public static void init() {
		...
		ModHandler.addShapedRecipe("ga_large_thermal_centrifuge", GATileEntities.LARGE_THERMAL_CENTRIFUGE.getStackForm(), "CBC", "RHR", "CDC", 'H', GATileEntities.THERMAL_CENTRIFUGE[4].getStackForm(), 'R', new UnificationEntry(OrePrefix.stick, Materials.RedSteel), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'C', new UnificationEntry(OrePrefix.plate, Materials.RedSteel), 'D', new UnificationEntry(OrePrefix.gear, Materials.RedSteel));
		ModHandler.addShapedRecipe("ga_large_bender_and_forming", GATileEntities.LARGE_BENDER_AND_FORMING.getStackForm(), "CBC", "RHR", "CBC", 'H', MetaTileEntities.BENDER[3].getStackForm(), 'R', MetaTileEntities.HULL[GTValues.EV].getStackForm(), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Advanced), 'C', new UnificationEntry(OrePrefix.plate, Materials.Titanium));
		ModHandler.addShapedRecipe("ga_large_centrifuge", GATileEntities.LARGE_CENTRIFUGE.getStackForm(), "CBC", "RHR", "DED", 'H', MetaTileEntities.CENTRIFUGE[3].getStackForm(), 'E', MetaTileEntities.HULL[GTValues.IV].getStackForm(), 'C', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'B', new UnificationEntry(OrePrefix.pipeLarge, Materials.StainlessSteel), 'D', new UnificationEntry(OrePrefix.plate, GAMaterials.Tumbaga), 'R', new UnificationEntry(OrePrefix.plate, Materials.Titanium));
		ModHandler.addShapedRecipe("ga_large_chemical_reactor", GATileEntities.LARGE_CHEMICAL_REACTOR.getStackForm(), "DBD", "CHC", "DED", 'H', GATileEntities.CHEMICAL_REACTOR[4].getStackForm(), 'E', MetaTileEntities.HULL[GTValues.LuV].getStackForm(), 'C', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Elite), 'B', new UnificationEntry(OrePrefix.pipeLarge, Materials.StainlessSteel), 'D', GAMetaBlocks.MUTLIBLOCK_CASING.getItemVariant(GAMultiblockCasing.CasingType.CHEMICALLY_INERT));
		ModHandler.addShapedRecipe("ga_large_cutting", GATileEntities.LARGE_CUTTING.getStackForm(), "DBD", "CHC", "DED", 'H', GATileEntities.CUTTER[4].getStackForm(), 'C', MetaTileEntities.HULL[GTValues.IV].getStackForm(), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Advanced), 'E', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'D', new UnificationEntry(OrePrefix.plate, GAMaterials.MaragingSteel250));
		ModHandler.addShapedRecipe("ga_large_electrolyzer", GATileEntities.LARGE_ELECTROLYZER.getStackForm(), "DBD", "CHC", "DED", 'H', MetaTileEntities.ELECTROLYZER[3].getStackForm(), 'C', MetaTileEntities.HULL[GTValues.EV].getStackForm(), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'E', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'D', new UnificationEntry(OrePrefix.plate, GAMaterials.Stellite));
		ModHandler.addShapedRecipe("ga_large_extruder", GATileEntities.LARGE_EXTRUDER.getStackForm(), "DBD", "CHC", "DED", 'H', MetaTileEntities.EXTRUDER[2].getStackForm(), 'C', MetaTileEntities.HULL[GTValues.EV].getStackForm(), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'E', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'D', new UnificationEntry(OrePrefix.plate, GAMaterials.Inconel625));
		ModHandler.addShapedRecipe("ga_large_macerator", GATileEntities.LARGE_MACERATOR.getStackForm(), "DBD", "CHC", "DED", 'C', MetaTileEntities.MACERATOR[2].getStackForm(), 'E', MetaTileEntities.HULL[GTValues.IV].getStackForm(), 'H', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Master), 'B', MetaTileEntities.MACERATOR[3].getStackForm(), 'D', new UnificationEntry(OrePrefix.plate, Materials.TungstenCarbide));
		ModHandler.addShapedRecipe("ga_large_mixer", GATileEntities.LARGE_MIXER.getStackForm(), "DED", "CHC", "DED", 'C', new UnificationEntry(OrePrefix.plate, Materials.TungstenCarbide), 'E', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'H', MetaTileEntities.MIXER[3].getStackForm(), 'D', new UnificationEntry(OrePrefix.plate, GAMaterials.Staballoy));
		ModHandler.addShapedRecipe("ga_large_multi_use", GATileEntities.LARGE_MULTI_USE.getStackForm(), "ABC", "DED", "GHI", 'A', MetaTileEntities.COMPRESSOR[3].getStackForm(), 'B', MetaTileEntities.LATHE[3].getStackForm(), 'C', MetaTileEntities.POLARIZER[3].getStackForm(), 'D', new UnificationEntry(OrePrefix.plate, GAMaterials.Staballoy), 'E', MetaTileEntities.HULL[GTValues.EV].getStackForm(), 'G', MetaTileEntities.FERMENTER[3].getStackForm(), 'H', MetaTileEntities.LASER_ENGRAVER[3].getStackForm(), 'I', MetaTileEntities.EXTRACTOR[3].getStackForm() );
		ModHandler.addShapedRecipe("ga_large_sifter", GATileEntities.LARGE_SIFTER.getStackForm(), "DBD", "CHC", "DED", 'H', MetaTileEntities.SIFTER[3].getStackForm(), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Good), 'E', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Advanced), 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Gold), 'D', new UnificationEntry(OrePrefix.plate, GAMaterials.EglinSteel));
		...
		if (GAConfig.GT5U.highTierThermalCentrifuges) registerMachineRecipe(THERMAL_CENTRIFUGE, "CEC", "OMO", "WEW", 'M', HULL, 'E', MOTOR, 'C', CIRCUIT, 'W', CABLE, 'O', COIL_HEATING_DOUBLE);
