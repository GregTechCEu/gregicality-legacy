...
//        ModHandler.addShapedRecipe("ga_energy_output_hatch_max", GATileEntities.ENERGY_OUTPUT[GTValues.MAX].getStackForm(), "   ", " MC", "   ", 'M', MetaTileEntities.HULL[GTValues.MAX].getStackForm(), 'C', new UnificationEntry(wireGtSingle, Neutronium));
        ...
        ModHandler.addShapedRecipe("ga_large_plasma_turbine", GATileEntities.LARGE_PLASMA_TURBINE.getStackForm(), "PSP", "SAS", "CSC", 'S', new UnificationEntry(gear, TungstenSteel), 'P', new UnificationEntry(circuit, Tier.Master), 'A', MetaTileEntities.HULL[GAValues.LuV].getStackForm(), 'C', OreDictUnifier.get(pipeLarge, TungstenSteel));
