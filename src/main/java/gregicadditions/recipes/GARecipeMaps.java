...
public class GARecipeMaps {
    ...
    @ZenProperty
    public static final FuelRecipeMap HOT_COOLANT_TURBINE_FUELS;
    @ZenProperty
    ...
    static {
        ...
        BOILING_THORIUM_REACTOR_RECIPES = new RecipeMap<>("boiling_thorium_reactor", 1, 1, 1, 12, 0, 0, 0, 6, new SimpleRecipeBuilder()).setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, ProgressWidget.MoveType.HORIZONTAL);
        BOILING_URANIUM_REACTOR_RECIPES = new RecipeMap<>("boiling_uranium_reactor", 1, 1, 1, 12, 0, 0, 0, 6, new SimpleRecipeBuilder()).setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, ProgressWidget.MoveType.HORIZONTAL);
        BOILING_PLUTONIUM_REACTOR_RECIPES = new RecipeMap<>("boiling_plutonium_reactor", 1, 1, 1, 12, 0, 0, 0, 0, new SimpleRecipeBuilder()).setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, ProgressWidget.MoveType.HORIZONTAL);
        ...
        HOT_COOLANT_TURBINE_FUELS = new FuelRecipeMap("hot_coolant_turbine");
