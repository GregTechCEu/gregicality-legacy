...
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelTRISO, 1))
//                .fluidInputs(Fluorine.getFluid(8000))
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuel, 1))
...
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelZirconiumAlloy, 1))
...
//        // Fuel + O = [Fuel + O]
//        CHEMICAL_RECIPES.recipeBuilder().EUt(30).duration(300)
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuel, 1))
//                .fluidInputs(Oxygen.getFluid(1000))
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelOxide, 1))
//                .buildAndRegister();
//
...
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelOxide, 1))
...
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelNitride, 1))
...
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelNitride, 1))
...
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.zirconiumAlloy, 1))
//                .buildAndRegister();
//
//        // [Fuel + Zr] + 4Cl = Fuel + ZrCl4
//        LARGE_CHEMICAL_RECIPES.recipeBuilder().EUt(30).duration(300)
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.zirconiumAlloy, 1))
...
//                .input(ingot, isotopeMaterial.getMaterial())
//                .fluidInputs(Oxygen.getFluid(1000))
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.oxide, 1))
//                .buildAndRegister();
//
//        // [Fuel + O] + 2C = [Fuel + C] + CO
//        CHEMICAL_RECIPES.recipeBuilder().EUt(30).duration(300)
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.oxide, 1))
//                .input(dust, Carbon, 2)
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.carbide, 1))
...
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.carbide, 1))
...
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.nitride, 2))
//                .fluidOutputs(CarbonMonoxde.getFluid(1000))
//                .buildAndRegister();
//
//        // Fuel2N3 + 4H2O + 3O = 2[Fuel + 2O] + H2O + NO2 + 2NH3
//        LARGE_CHEMICAL_RECIPES.recipeBuilder().EUt(30).duration(300)
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.nitride, 1))
//                .fluidInputs(Water.getFluid(3000))
//                .fluidInputs(Oxygen.getFluid(3000))
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.oxide, 2))
...
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelCarbide, 1))
//                .buildAndRegister();
//
//        ALLOY_SMELTER_RECIPES.recipeBuilder().EUt(480).duration(200)
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.zirconiumAlloy, 1))
//                .notConsumable(SHAPE_MOLD_BALL.getStackForm())
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelZirconiumAlloy, 1))
//                .buildAndRegister();
//
//        ALLOY_SMELTER_RECIPES.recipeBuilder().EUt(480).duration(200)
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.nitride, 1))
//                .notConsumable(SHAPE_MOLD_BALL.getStackForm())
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelNitride, 1))
//                .buildAndRegister();
//
//        ALLOY_SMELTER_RECIPES.recipeBuilder().EUt(480).duration(200)
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.oxide, 1))
//                .notConsumable(SHAPE_MOLD_BALL.getStackForm())
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelOxide, 1))
//                .buildAndRegister();
//
//        ALLOY_SMELTER_RECIPES.recipeBuilder().EUt(480).duration(200)
//                .input(ingot, isotopeMaterial.getMaterial())
//                .notConsumable(SHAPE_MOLD_BALL.getStackForm())
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelPure, 1))
//                .buildAndRegister();
//
//        ASSEMBLER_RECIPES.recipeBuilder().EUt(480).duration(200)
//                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelCarbide, 1))
//                .notConsumable(SHAPE_MOLD_BALL.getStackForm())
//                .inputs(PYROLYTIC_CARBON.getStackForm())
//                .input(dust, Graphite)
//                .inputs(SiliconCarbide.getItemStack())
//                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelTRISO, 1))
//                .buildAndRegister();
//    }
//
//
...
//                    .outputs(radioactiveMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.nitrite, 3))
//                    .fluidOutputs(Hydrogen.getFluid(2000))
//                    .buildAndRegister();
//
//            // [Mat + 2NO3] = [Mat + 2O] + 2NO
//            BLAST_RECIPES.recipeBuilder().blastFurnaceTemp(600).duration(90 * complexity / 100).EUt(120)
//                    .inputs(radioactiveMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.nitrite, 3))
//                    .outputs(radioactiveMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.dioxide, 1))
//                    .fluidOutputs(NitricOxide.getFluid(2000))
//                    .buildAndRegister();
//
//            // [Mat + 2O] + 6Cl = [Mat + 6Cl] + 2O
//            CHEMICAL_RECIPES.recipeBuilder().duration(1000 * complexity / 100)
//                    .inputs(radioactiveMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.dioxide, 1))
...
//                        .outputs(key.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.dioxide, 3))
...
//                        .inputs(key.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.dioxide, 3))
...
//                        .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelTRISO, operand))
//                        .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelTRISO, operand))
//                        .buildAndRegister();
//
//                NUCLEAR_REACTOR_RECIPES.recipeBuilder().duration(8000).EUt(((isotopeMaterial.baseHeat + operand) * operand * 2) * 105 / 100) //8000 => 105% eff
//                        .baseHeatProduction((isotopeMaterial.baseHeat + operand) * operand * 2)
//                        .notConsumable(new IntCircuitIngredient(operand + 10))
//                        .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelOxide, operand))
//                        .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelOxide, operand))
//                        .buildAndRegister();
//
...
//                        .baseHeatProduction((isotopeMaterial.baseHeat + operand) * operand * 2)
//                        .notConsumable(new IntCircuitIngredient(operand + 10))
//                        .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelNitride, operand))
//                        .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelNitride, operand))
//                        .buildAndRegister();
//
...
//                        .baseHeatProduction((isotopeMaterial.baseHeat + operand) * operand * 2)
//                        .notConsumable(new IntCircuitIngredient(operand + 10))
//                        .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelZirconiumAlloy, operand))
//                        .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelZirconiumAlloy, operand))
//                        .buildAndRegister();
//            });
//
//            IntStream.range(1, 10).forEach(operand ->
...
//                                                .inputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelTRISO, operand))
//                                                .inputs(isotopeMaterialEntry.getValue().getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.fuelPure, 9))
//                                                .outputs(isotopeMaterial.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuelTRISO, operand))
//                                                .outputs(isotopeMaterialEntry.getValue().getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuel, 9))
//                                                .buildAndRegister();
//
...
//                                                builder1.chancedOutput(key.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuel, 9), value, 100));
//                                        builder1.buildAndRegister();
//
...
//
//                                        isotopeMaterialEntry.getValue().isotopeDecay.forEach((key, value) ->
//                                                builder2.chancedOutput(key.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuel, 9), value, 100));
...
//
//                                        isotopeMaterialEntry.getValue().isotopeDecay.forEach((key, value) ->
//                                                builder3.chancedOutput(key.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuel, 9), value, 100));
...
//
//                                        isotopeMaterialEntry.getValue().isotopeDecay.forEach((key, value) ->
//                                                builder4.chancedOutput(key.getItemStack(GAEnums.gregicadditions.materials.GAOrePrefix.depletedFuel, 9), value, 100));
...
//                        .input(GAEnums.gregicadditions.materials.GAOrePrefix.fuelOxide, isotopeMaterial.getMaterial())
//                        .chancedOutput(OreDictUnifier.get(GAEnums.gregicadditions.materials.GAOrePrefix.fuelOxide, isotopeMaterialDecay.getMaterial()), 9000, 100)
//                        .buildAndRegister();
//
//                DECAY_CHAMBERS_RECIPES.recipeBuilder().duration(600).EUt(30)
//                        .input(GAEnums.gregicadditions.materials.GAOrePrefix.fuelNitride, isotopeMaterial.getMaterial())
//                        .chancedOutput(OreDictUnifier.get(GAEnums.gregicadditions.materials.GAOrePrefix.fuelNitride, isotopeMaterialDecay.getMaterial()), 9000, 100)
//                        .buildAndRegister();
//
//                DECAY_CHAMBERS_RECIPES.recipeBuilder().duration(600).EUt(30)
//                        .input(GAEnums.gregicadditions.materials.GAOrePrefix.fuelTRISO, isotopeMaterial.getMaterial())
//                        .chancedOutput(OreDictUnifier.get(GAEnums.gregicadditions.materials.GAOrePrefix.fuelTRISO, isotopeMaterialDecay.getMaterial()), 9000, 100)
//                        .buildAndRegister();
//
//                DECAY_CHAMBERS_RECIPES.recipeBuilder().duration(600).EUt(30)
//                        .input(GAEnums.gregicadditions.materials.GAOrePrefix.fuelZirconiumAlloy, isotopeMaterial.getMaterial())
//                        .chancedOutput(OreDictUnifier.get(GAEnums.gregicadditions.materials.GAOrePrefix.fuelZirconiumAlloy, isotopeMaterialDecay.getMaterial()), 9000, 100)
//                        .buildAndRegister();
//
//            });
//        }
