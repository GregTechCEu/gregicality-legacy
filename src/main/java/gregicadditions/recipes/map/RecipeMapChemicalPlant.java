...
public class RecipeMapChemicalPlant<R extends RecipeBuilder<R>> extends RecipeMap<R> {
    ...
    public RecipeMapChemicalPlant(String unlocalizedName, int minInputs, int maxInputs, int minOutputs, int maxOutputs, int minFluidInputs, int maxFluidInputs, int minFluidOutputs, int maxFluidOutputs, R defaultRecipe) {
    ...
    @Override
    public RecipeMapChemicalPlant<R> setProgressBar(TextureArea progressBar, ProgressWidget.MoveType moveType) {
