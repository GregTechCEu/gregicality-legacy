...
public class Batteries {
    public static void init() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder()
                .input(plateCurved, RhodiumPlatedPalladium, 4)
                .input(plateCurved, Vanadium, 6)
                ...
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder()
                .input(plateCurved, HSSS, 4)
                .input(plateCurved, Naquadria, 2)
                ...
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder()
                .input(plateCurved, Tritanium, 4)
                .input(plateCurved, Naquadria, 4)
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .input(plateCurved, NaquadriaticTaranium, 2)
                ...
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder()
                .input(plateCurved, Quantum, 4)
                .input(cableGtSingle, BlackTitanium, 8)
                .input(plateCurved, NaquadriaticTaranium, 4)
                ...
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder()
                .input(plateCurved, Neutronium, 6)
                ...
                .buildAndRegister();
        ASSEMBLER_RECIPES.recipeBuilder()
                .input(plateCurved, CosmicNeutronium, 4)
