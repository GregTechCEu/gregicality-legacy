...
public class FullereneChain {
    public static void init() {
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .outputs(Bromosuccinimide.getItemStack(1))
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidInputs(ThionylChloride.getFluid(4000))
                .fluidInputs(Toluene.getFluid(1000))
                .fluidInputs(Water.getFluid(1000))
                .outputs(OreDictUnifier.get(dust, Pyrolusite, 6))
                .outputs(OreDictUnifier.get(dust, Salt, 9))
                .fluidOutputs(PotassiumHydroxide.getFluid(3000))
