...
public class Lasers {
    public static void init() {
        ...
        // [Al2O3  + CH2Cl2 + 2C12H27N] + Neodymium Doped Yttrium + (NH2)CO(NH2) = Unprocessed Nd:YAG + 2C12H27N
        ...
        CHEMICAL_RECIPES.recipeBuilder().duration(180).EUt(2000)
                ...
                .outputs(CesiumHydroxide.getItemStack(4))
                .buildAndRegister();
        ...
        // NH4VO3 + 3NaCl + 2Na = Na3VO4 + NH4Cl + 2NaCl
        ...
        CHEMICAL_RECIPES.recipeBuilder().duration(320).EUt(940)
                ...
                .fluidInputs(Water.getFluid(2000))
                .outputs(OreDictUnifier.get(dust,SiliconDioxide, 2))
