...
public class NaquadahChain {
    ...
    public static void init() {
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .input(dust, NaquadriaConcentrate)
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                .input(dust, EnrichedNaquadahConcentrate)
                .fluidInputs(Fluorine.getFluid(6000))
        ...
        LARGE_CENTRIFUGE_RECIPES.recipeBuilder()
                ...
                .output(dustTiny, Uranium235)
                .output(dustTiny, NaquadahEnriched)
                .output(dustTiny, Plutonium241)
                .EUt(7680)
                .duration(100)
                .buildAndRegister();
        ...
        LARGE_MIXER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Californium256.getFluid(144))
