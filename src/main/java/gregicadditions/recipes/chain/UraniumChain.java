...
public class UraniumChain {
    public static void init() {
        // Uraninite and Pitchblene MUST NOT be creatable from each's respective components
        ...
        ELECTROLYZER_RECIPES.recipeBuilder().duration(220).EUt(120)
                ...
                .outputs(OreDictUnifier.get(dust, Barium))
        ...
        MIXER_RECIPES.recipeBuilder().duration(100).EUt(500)
                ...
                .outputs(OreDictUnifier.get(GAEnums.GAOrePrefix.dioxide, UraniumRadioactive.getMaterial(), 3))
        ...
        ELECTROLYZER_RECIPES.recipeBuilder().duration(250).EUt(500)
                ...
                .outputs(OreDictUnifier.get(GAEnums.GAOrePrefix.oxide, Thorium, 2))
        ...
        BLAST_RECIPES.recipeBuilder().duration(250).EUt(500).blastFurnaceTemp(1000)
                .input(GAEnums.GAOrePrefix.oxide, Thorium, 2)
