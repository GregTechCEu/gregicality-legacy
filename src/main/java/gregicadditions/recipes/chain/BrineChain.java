...
public class BrineChain {
    public static void init() {
        ...
        CHEMICAL_RECIPES.recipeBuilder().duration(180).EUt(4096)
                .input(dust, Iridium)
                ...
                .output(dust, DehydrogenationCatalyst)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder().duration(200).EUt(120)
                ...
                .output(dust, Calcite, 5)
                .chancedOutput(OreDictUnifier.get(dust, StrontiumCarbonate, 5), 40, 0)
