...
public class ProspectingPacket {
    ...
    public ProspectingPacket(int chunkX, int chunkZ, int posX, int posZ, int mode) {
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
        this.posX = posX;
        this.posZ = posZ;
    ...
    public static ProspectingPacket readPacketData(PacketBuffer buffer) {
        ProspectingPacket packet = new ProspectingPacket(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt());
        int aSize = 0;
        if (packet.mode == 0)
            aSize = 16;
