...
public abstract class GATieredMetaTileEntity extends MetaTileEntity implements IEnergyChangeListener, ITieredMetaTileEntity {

    private final int tier;
    protected IEnergyContainer energyContainer;

    public GATieredMetaTileEntity(ResourceLocation metaTileEntityId, int tier) {
    ...
    private SimpleSidedCubeRenderer getBaseRenderer() {
        return Textures.VOLTAGE_CASINGS[GTValues.MAX];
    }
