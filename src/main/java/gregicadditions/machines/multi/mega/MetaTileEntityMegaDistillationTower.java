...
public class MetaTileEntityMegaDistillationTower extends MegaMultiblockRecipeMapController {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(RIGHT, FRONT, UP)
                ...
                .where('X', abilityPartPredicate(MultiblockAbility.EXPORT_FLUIDS).or(statePredicate(getCasingState())).or(abilityPartPredicate(MultiblockAbility.MAINTENANCE_HATCH)))
