...
public class MetaTileEntityMegaDistillationTower extends MultiRecipeMapMultiblockController {
    ...
    public MetaTileEntityMegaDistillationTower(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap) {
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new MetaTileEntityMegaDistillationTower(metaTileEntityId, RecipeMaps.DISTILLATION_RECIPES);
    }
    ...
    protected BlockPattern createStructurePattern() {
        ...
        return FactoryBlockPattern.start(RIGHT, FRONT, UP)
                ...
                .aisle("#XXX#", "XCACX", "XAPAX", "XCACX", "#XXX#").setRepeatable(0, 11)
