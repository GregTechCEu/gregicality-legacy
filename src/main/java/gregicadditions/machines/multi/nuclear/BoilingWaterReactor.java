...
public class BoilingWaterReactor extends RecipeMapMultiblockController {
    ...
    public enum RodType {
        THORIUM(GARecipeMaps.BOILING_THORIUM_REACTOR_RECIPES, 4500, 3.0f, 31, 2000,
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        if (this.isStructureFormed()) {
            textList.add(new TextComponentTranslation("gregtech.multiblock.large_boiler.temperature", this.currentTemperature, this.rodType.maxTemperature));
            int steamOutput = 0;
            ...
            textList.add(new TextComponentTranslation("gregtech.multiblock.large_boiler.steam_output", steamOutput, this.rodType.baseSteamOutput));
        }
...
//				}
                ...
                if (currentTemperature >= BOILING_TEMPERATURE) {
                    ...
                    FluidStack steamStack = GAMaterials.HighPressureSteam.getFluid(steamOutput);
